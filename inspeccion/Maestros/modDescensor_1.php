...
// Write the SQL Query
$grid->SelectCommand = 'SELECT * FROM ModeloDes WHERE IdMarca='.$_SESSION['Marca'];
$grid->table='ModeloDes';		  	  // set the table where add-del-edit data
...
$grid->setUrl('modDescensor_1.php');  // Set the url from where we obtain the data

$grid->setColProperty("Id", array("label"=>"Codigo","align"=>"right","editable"=>false,"width"=>40));
$grid->setColProperty("IdMarca", array("label"=>"Marca","hidden"=>true,"editoptions"=>array("defaultValue"=>$_SESSION['Marca'])));
$grid->setColProperty("Nombre", array("label"=>"Nombre", "width"=>75, "editoptions"=>array("maxlength"=>25)));
$grid->setGridOptions(array(
    "caption"=>"Modelo Descensor",
    "sortable"=>true,
	"scroll"=>1,
	"rowNum"=>100,
    "width"=>$ancho_grid,
	...
	"recordtext"=>"{2} Modelos",
	"emptyrecords"=>"No hay Modelos",
	"autowidth"=>false,
	"cellLayout"=>7,
	"hiddengrid"=>false,
	"hidegrid"=>false,
