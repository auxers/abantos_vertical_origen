...
$Parque = (isset($_POST['Parque'])) ? $_POST['Parque'] : "";
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#Form").submit(function() {
				...
				if ($("#Tipo").val() == "M")		 // Montaje
					sFichero += "ImpCerM.php";
				else if ($("#Tipo").val() == "R")	// Revisión	
					sFichero += "ImpCerR.php";
				else if ($("#Tipo").val() == "D")	// Descensores
					sFichero += "ImpCerD.php";
				else								 // Extintores
					sFichero += "ImpCerE.php";
				sFichero += "?Parque="+$("#Parque").val()+"&FechaIni="+$("#FechaIni").val()+"&FechaFin="+$("#FechaFin").val();
				...
				if ($("#Tipo").val() != "E")
				{
					window.parent.$("#ModalPdf").attr("title", "CERTIFICADO POR " + (($("#Tipo").val() == "M")? "MÁQUINA" : "PARQUE"));
...
<body>
	<div align=center style="margin-top:5px;padding-bottom:10px;" >
		<form name="control" id="Form" method="post">
			<table class="table" cellpadding=0 cellspacing=0 width="85%">
				<tr>
					<td height=30>
						<table cellpading=0 cellspacing=0>
							<tr>
								<td class="header_L">&nbsp;</td>
								<td class="header_C"><span class='header_title'>CERTIFICADO DE MONTAJE Y REVISIÓN POR PARQUE</span></td>
				...
				<tr>
					<td height=auto valign=top style="padding:10px;border-left:1px solid #dddddd;border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;background-color:#ffffff;">
						<table class="table" cellpadding=0 cellspacing=0 bgcolor='#fff'>
							<tr>
                                <td>
                                ...
                                <td style="width:325px;">
									<SELECT NAME="Parque" ID="Parque" SIZE="1" style="width:325px;">
										<?php
