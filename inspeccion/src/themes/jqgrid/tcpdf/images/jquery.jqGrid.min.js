...
d||(d="Y-m-d");c=i.getHours();e=i.getMinutes();g=i.getDate();h=i.getMonth()+1;j=i.getTimezoneOffset();k=i.getSeconds();var m=i.getMilliseconds(),o=i.getDay(),n=i.getFullYear(),l=(o+6)%7+1,p=(new Date(n,h-1,g)-new Date(n,0,1))/864E5,q={d:b(g),D:f.dayNames[o],j:g,l:f.dayNames[o+7],N:l,S:f.S(g),w:o,z:p,W:5>l?Math.floor((p+l-1)/7)+1:Math.floor((p+l-1)/7)||(4>((new Date(n-1,0,1)).getDay()+6)%7?53:52),F:f.monthNames[h-1+12],m:b(h),M:f.monthNames[h-1],n:h,t:"?",L:"?",o:"?",Y:n,y:(""+n).substring(2),a:12>
...
this,b=c,h=!0,g=!1,i=d,j=/[\$,%]/g,k=null,m=null,o=0,n=!1,l="",p=[],q=!0;if("object"===typeof c&&c.push)0<c.length&&(q="object"!==typeof c[0]?!1:!0);else throw"data provides is not an array";this._hasData=function(){return null===b?!1:0===b.length?!1:!0};this._getStr=function(a){var b=[];g&&b.push("jQuery.trim(");b.push("String("+a+")");g&&b.push(")");h||b.push(".toLowerCase()");return b.join("")};this._strComp=function(a){return"string"===typeof a?".toString()":""};this._group=function(a,b){return{field:a.toString(),
unique:b,items:[]}};this._toStr=function(b){g&&(b=a.trim(b));b=b.toString().replace(/\\/g,"\\\\").replace(/\"/g,'\\"');return h?b:b.toLowerCase()};this._funcLoop=function(d){var c=[];a.each(b,function(a,b){c.push(d(b))});return c};this._append=function(a){var b;i=null===i?"":i+(""===l?" && ":l);for(b=0;b<o;b++)i+="(";n&&(i+="!");i+="("+a+")";n=!1;l="";o=0};this._setCommand=function(a,b){k=a;m=b};this._resetNegate=function(){n=!1};this._repeatCommand=function(a,b){return null===k?f:null!==a&&null!==
...
this.data=function(){return b};this.select=function(d){f._performSort();if(!f._hasData())return[];f.execute();if(a.isFunction(d)){var c=[];a.each(b,function(a,b){c.push(d(b))});return c}return b};this.hasMatch=function(){if(!f._hasData())return!1;f.execute();return 0<b.length};this.andNot=function(a,b,d){n=!n;return f.and(a,b,d)};this.orNot=function(a,b,d){n=!n;return f.or(a,b,d)};this.not=function(a,b,d){return f.andNot(a,b,d)};this.and=function(a,b,d){l=" && ";return void 0===a?f:f._repeatCommand(a,
b,d)};this.or=function(a,b,d){l=" || ";return void 0===a?f:f._repeatCommand(a,b,d)};this.orBegin=function(){o++;return f};this.orEnd=function(){null!==i&&(i+=")");return f};this.isNot=function(a){n=!n;return f.is(a)};this.is=function(a){f._append("this."+a);f._resetNegate();return f};this._compareValues=function(b,d,c,e,g){var h;h=q?"jQuery.jgrid.getAccessor(this,'"+d+"')":"this";void 0===c&&(c=null);var i=c,l=void 0===g.stype?"text":g.stype;if(null!==c)switch(l){case "int":case "integer":i=isNaN(Number(i))||
...
i;var l=d.rowNum;g=e.scrollTop=e.bDiv.scrollTop;var m=Math.round(c.position().top)-g,k=m+c.height();i*=l;var n,o,q;if(k<b&&0>=m&&(void 0===d.lastpage||parseInt((k+g+i-1)/i,10)<=d.lastpage))o=parseInt((b-k+i-1)/i,10),0<=k||2>o||!0===d.scroll?(n=Math.round((k+g)/i)+1,m=-1):m=1;0<m&&(n=parseInt(g/i,10)+1,o=parseInt((g+b)/i,10)+2-n,q=!0);if(o&&(!d.lastpage||!(n>d.lastpage||1===d.lastpage||n===d.page&&n===d.lastpage)))e.hDiv.loading?e.timer=setTimeout(e.populateVisible,d.scrollTimeout):(d.page=n,q&&(e.selectionPreserver(c[0]),
...
"aria-labelledby":"gbox_"+this.id});var o=function(a,b){a=parseInt(a,10);return isNaN(a)?b||0:a},n=function(d,c,f,g,i,j){var l=b.p.colModel[d],m=l.align,k='style="',n=l.classes,o=l.name,q=[];m&&(k=k+("text-align:"+m+";"));l.hidden===true&&(k=k+"display:none;");if(c===0)k=k+("width: "+e.headers[d].width+"px;");else if(l.cellattr&&a.isFunction(l.cellattr))if((d=l.cellattr.call(b,i,f,g,l,j))&&typeof d==="string"){d=d.replace(/style/i,"style").replace(/title/i,"title");if(d.indexOf("title")>-1)l.title=
false;d.indexOf("class")>-1&&(n=void 0);q=d.replace("-style","-sti").split(/style/);if(q.length===2){q[1]=a.trim(q[1].replace("-sti","-style").replace("=",""));if(q[1].indexOf("'")===0||q[1].indexOf('"')===0)q[1]=q[1].substring(1);k=k+q[1].replace(/'/gi,'"')}else k=k+'"'}if(!q.length){q[0]="";k=k+'"'}k=k+((n!==void 0?' class="'+n+'"':"")+(l.title&&f?' title="'+a.jgrid.stripHtml(f)+'"':""));k=k+(' aria-describedby="'+b.p.id+"_"+o+'"');return k+q[0]},l=function(d){return d==null||d===""?"&#160;":b.p.autoencode?
a.jgrid.htmlEncode(d):""+d},p=function(d,c,e,f,g){var i=b.p.colModel[e];if(i.formatter!==void 0){d=""+b.p.idPrefix!==""?a.jgrid.stripPref(b.p.idPrefix,d):d;d={rowId:d,colModel:i,gid:b.p.id,pos:e};c=a.isFunction(i.formatter)?i.formatter.call(b,c,d,f,g):a.fmatter?a.fn.fmatter.call(b,i.formatter,c,d,f,g):l(c)}else c=l(c);return c},q=function(a,b,d,c,e,f){b=p(a,b,d,e,"add");return'<td role="gridcell" '+n(d,c,b,e,a,f)+">"+b+"</td>"},r=function(a,d,c,e){e='<input role="checkbox" type="checkbox" id="jqg_'+
b.p.id+"_"+a+'" class="cbox" name="jqg_'+b.p.id+"_"+a+'"'+(e?'checked="checked"':"")+"/>";return'<td role="gridcell" '+n(d,c,"",null,a,true)+">"+e+"</td>"},s=function(a,b,d,c){d=(parseInt(d,10)-1)*parseInt(c,10)+1+b;return'<td role="gridcell" class="ui-state-default jqgrid-rownum" '+n(a,b,d,null,b,true)+">"+d+"</td>"},t=function(a){var d,c=[],e=0,f;for(f=0;f<b.p.colModel.length;f++){d=b.p.colModel[f];if(d.name!=="cb"&&d.name!=="subgrid"&&d.name!=="rn"){c[e]=a==="local"?d.name:a==="xml"||a==="xmlstring"?
d.xmlmap||d.name:d.jsonmap||d.name;e++}}return c},u=function(d){var c=b.p.remapColumns;if(!c||!c.length)c=a.map(b.p.colModel,function(a,b){return b});d&&(c=a.map(c,function(a){return a<d?null:a-d}));return c},w=function(b,d){var c;if(this.p.deepempty)a(this.rows).slice(1).remove();else{c=this.rows.length>0?this.rows[0]:null;a(this.firstChild).empty().append(c)}if(b&&this.p.scroll){a(this.grid.bDiv.firstChild).css({height:"auto"});a(this.grid.bDiv.firstChild.firstChild).css({height:0,display:"none"});
if(this.grid.bDiv.scrollTop!==0)this.grid.bDiv.scrollTop=0}if(d===true&&this.p.treeGrid){this.p.data=[];this.p._index={}}},z=function(){var d=b.p.data.length,c,e,f;c=b.p.rownumbers===true?1:0;e=b.p.multiselect===true?1:0;f=b.p.subGrid===true?1:0;c=b.p.keyIndex===false||b.p.loadonce===true?b.p.localReader.id:b.p.colModel[b.p.keyIndex+e+f+c].name;for(e=0;e<d;e++){f=a.jgrid.getAccessor(b.p.data[e],c);f===void 0&&(f=""+(e+1));b.p._index[f]=e}},J=function(d,c,e,f,g,i){var h="-1",j="",l,c=c?"display:none;":
"",e="ui-widget-content jqgrow ui-row-"+b.p.direction+(e?" "+e:"")+(i?" ui-state-highlight":""),i=a(b).triggerHandler("jqGridRowAttr",[f,g,d]);typeof i!=="object"&&(i=a.isFunction(b.p.rowattr)?b.p.rowattr.call(b,f,g,d):{});if(!a.isEmptyObject(i)){if(i.hasOwnProperty("id")){d=i.id;delete i.id}if(i.hasOwnProperty("tabindex")){h=i.tabindex;delete i.tabindex}if(i.hasOwnProperty("style")){c=c+i.style;delete i.style}if(i.hasOwnProperty("class")){e=e+(" "+i["class"]);delete i["class"]}try{delete i.role}catch(m){}for(l in i)i.hasOwnProperty(l)&&
(j=j+(" "+l+"="+i[l]))}return'<tr role="row" id="'+d+'" tabindex="'+h+'" class="'+e+'"'+(c===""?"":' style="'+c+'"')+j+">"},x=function(d,c,e,f,g){var i=new Date,h=b.p.datatype!=="local"&&b.p.loadonce||b.p.datatype==="xmlstring",j=b.p.xmlReader,l=b.p.datatype==="local"?"local":"xml";if(h){b.p.data=[];b.p._index={};b.p.localReader.id="_id_"}b.p.reccount=0;if(a.isXMLDoc(d)){if(b.p.treeANode===-1&&!b.p.scroll){w.call(b,false,true);e=1}else e=e>1?e:1;var m=a(b),k,n,o=0,p,x=b.p.multiselect===true?1:0,D=
0,z,H=b.p.rownumbers===true?1:0,v,B=[],I,A={},G,E,M=[],C=b.p.altRows===true?b.p.altclass:"",Q;if(b.p.subGrid===true){D=1;z=a.jgrid.getMethod("addSubGridCell")}j.repeatitems||(B=t(l));v=b.p.keyIndex===false?a.isFunction(j.id)?j.id.call(b,d):j.id:b.p.keyIndex;if(B.length>0&&!isNaN(v)){b.p.remapColumns&&b.p.remapColumns.length&&(v=a.inArray(v,b.p.remapColumns));v=B[v]}l=(""+v).indexOf("[")===-1?B.length?function(b,d){return a(v,b).text()||d}:function(b,d){return a(j.cell,b).eq(v).text()||d}:function(a,
b){return a.getAttribute(v.replace(/[\[\]]/g,""))||b};b.p.userData={};b.p.page=a.jgrid.getXmlData(d,j.page)||b.p.page||0;b.p.lastpage=a.jgrid.getXmlData(d,j.total);if(b.p.lastpage===void 0)b.p.lastpage=1;b.p.records=a.jgrid.getXmlData(d,j.records)||0;a.isFunction(j.userdata)?b.p.userData=j.userdata.call(b,d)||{}:a.jgrid.getXmlData(d,j.userdata,true).each(function(){b.p.userData[this.getAttribute("name")]=a(this).text()});d=a.jgrid.getXmlData(d,j.root,true);(d=a.jgrid.getXmlData(d,j.row,true))||(d=
[]);var F=d.length,y=0,N=[],P=parseInt(b.p.rowNum,10),L=b.p.scroll?a.jgrid.randId():1;if(F>0&&b.p.page<=0)b.p.page=1;if(d&&F){g&&(P=P*(g+1));var g=a.isFunction(b.p.afterInsertRow),T=false,X;if(b.p.grouping){T=b.p.groupingView.groupCollapse===true;X=a.jgrid.getMethod("groupingPrepare")}for(;y<F;){G=d[y];E=l(G,L+y);E=b.p.idPrefix+E;k=e===0?0:e+1;Q=(k+y)%2===1?C:"";var K=M.length;M.push("");H&&M.push(s(0,y,b.p.page,b.p.rowNum));x&&M.push(r(E,H,y,false));D&&M.push(z.call(m,x+H,y+e));if(j.repeatitems){I||
(I=u(x+D+H));var O=a.jgrid.getXmlData(G,j.cell,true);a.each(I,function(a){var d=O[this];if(!d)return false;p=d.textContent||d.text;A[b.p.colModel[a+x+D+H].name]=p;M.push(q(E,p,a+x+D+H,y+e,G,A))})}else for(k=0;k<B.length;k++){p=a.jgrid.getXmlData(G,B[k]);A[b.p.colModel[k+x+D+H].name]=p;M.push(q(E,p,k+x+D+H,y+e,G,A))}M[K]=J(E,T,Q,A,G,false);M.push("</tr>");if(b.p.grouping){N=X.call(m,M,N,A,y);M=[]}if(h||b.p.treeGrid===true){A._id_=a.jgrid.stripPref(b.p.idPrefix,E);b.p.data.push(A);b.p._index[A._id_]=
b.p.data.length-1}if(b.p.gridview===false){a("tbody:first",c).append(M.join(""));m.triggerHandler("jqGridAfterInsertRow",[E,A,G]);g&&b.p.afterInsertRow.call(b,E,A,G);M=[]}A={};o++;y++;if(o===P)break}}if(b.p.gridview===true){n=b.p.treeANode>-1?b.p.treeANode:0;if(b.p.grouping){m.jqGrid("groupingRender",N,b.p.colModel.length);N=null}else b.p.treeGrid===true&&n>0?a(b.rows[n]).after(M.join("")):a("tbody:first",c).append(M.join(""))}if(b.p.subGrid===true)try{m.jqGrid("addSubGrid",x+H)}catch(U){}b.p.totaltime=
new Date-i;if(o>0&&b.p.records===0)b.p.records=F;M=null;if(b.p.treeGrid===true)try{m.jqGrid("setTreeNode",n+1,o+n+1)}catch(da){}if(!b.p.treeGrid&&!b.p.scroll)b.grid.bDiv.scrollTop=0;b.p.reccount=o;b.p.treeANode=-1;b.p.userDataOnFooter&&m.jqGrid("footerData","set",b.p.userData,true);if(h){b.p.records=F;b.p.lastpage=Math.ceil(F/P)}f||b.updatepager(false,true);if(h)for(;o<F;){G=d[o];E=l(G,o+L);E=b.p.idPrefix+E;if(j.repeatitems){I||(I=u(x+D+H));var S=a.jgrid.getXmlData(G,j.cell,true);a.each(I,function(a){var d=
S[this];if(!d)return false;p=d.textContent||d.text;A[b.p.colModel[a+x+D+H].name]=p})}else for(k=0;k<B.length;k++){p=a.jgrid.getXmlData(G,B[k]);A[b.p.colModel[k+x+D+H].name]=p}A._id_=a.jgrid.stripPref(b.p.idPrefix,E);b.p.data.push(A);b.p._index[A._id_]=b.p.data.length-1;A={};o++}}},B=function(d,c,e,f,g){var i=new Date;if(d){if(b.p.treeANode===-1&&!b.p.scroll){w.call(b,false,true);e=1}else e=e>1?e:1;var h,j=b.p.datatype!=="local"&&b.p.loadonce||b.p.datatype==="jsonstring";if(j){b.p.data=[];b.p._index=
{};b.p.localReader.id="_id_"}b.p.reccount=0;if(b.p.datatype==="local"){c=b.p.localReader;h="local"}else{c=b.p.jsonReader;h="json"}var l=a(b),k=0,m,n,o,p=[],x=b.p.multiselect?1:0,D=b.p.subGrid===true?1:0,z,H=b.p.rownumbers===true?1:0,v=u(x+D+H);h=t(h);var B,A,E,G={},I,y,F=[],C=b.p.altRows===true?b.p.altclass:"",Q;b.p.page=a.jgrid.getAccessor(d,c.page)||b.p.page||0;A=a.jgrid.getAccessor(d,c.total);D&&(z=a.jgrid.getMethod("addSubGridCell"));b.p.lastpage=A===void 0?1:A;b.p.records=a.jgrid.getAccessor(d,
c.records)||0;b.p.userData=a.jgrid.getAccessor(d,c.userdata)||{};E=b.p.keyIndex===false?a.isFunction(c.id)?c.id.call(b,d):c.id:b.p.keyIndex;if(!c.repeatitems){p=h;if(p.length>0&&!isNaN(E)){b.p.remapColumns&&b.p.remapColumns.length&&(E=a.inArray(E,b.p.remapColumns));E=p[E]}}A=a.jgrid.getAccessor(d,c.root);A==null&&a.isArray(d)&&(A=d);A||(A=[]);d=A.length;n=0;if(d>0&&b.p.page<=0)b.p.page=1;var N=parseInt(b.p.rowNum,10),P=b.p.scroll?a.jgrid.randId():1,L=false,T;g&&(N=N*(g+1));b.p.datatype==="local"&&
!b.p.deselectAfterSort&&(L=true);var X=a.isFunction(b.p.afterInsertRow),K=[],O=false,U;if(b.p.grouping){O=b.p.groupingView.groupCollapse===true;U=a.jgrid.getMethod("groupingPrepare")}for(;n<d;){g=A[n];y=a.jgrid.getAccessor(g,E);if(y===void 0){typeof E==="number"&&b.p.colModel[E+x+D+H]!=null&&(y=a.jgrid.getAccessor(g,b.p.colModel[E+x+D+H].name));if(y===void 0){y=P+n;if(p.length===0&&c.cell){m=a.jgrid.getAccessor(g,c.cell)||g;y=m!=null&&m[E]!==void 0?m[E]:y}}}y=b.p.idPrefix+y;m=e===1?0:e;Q=(m+n)%2===
1?C:"";L&&(T=b.p.multiselect?a.inArray(y,b.p.selarrrow)!==-1:y===b.p.selrow);var S=F.length;F.push("");H&&F.push(s(0,n,b.p.page,b.p.rowNum));x&&F.push(r(y,H,n,T));D&&F.push(z.call(l,x+H,n+e));B=h;if(c.repeatitems){c.cell&&(g=a.jgrid.getAccessor(g,c.cell)||g);a.isArray(g)&&(B=v)}for(o=0;o<B.length;o++){m=a.jgrid.getAccessor(g,B[o]);G[b.p.colModel[o+x+D+H].name]=m;F.push(q(y,m,o+x+D+H,n+e,g,G))}F[S]=J(y,O,Q,G,g,T);F.push("</tr>");if(b.p.grouping){K=U.call(l,F,K,G,n);F=[]}if(j||b.p.treeGrid===true){G._id_=
a.jgrid.stripPref(b.p.idPrefix,y);b.p.data.push(G);b.p._index[G._id_]=b.p.data.length-1}if(b.p.gridview===false){a("#"+a.jgrid.jqID(b.p.id)+" tbody:first").append(F.join(""));l.triggerHandler("jqGridAfterInsertRow",[y,G,g]);X&&b.p.afterInsertRow.call(b,y,G,g);F=[]}G={};k++;n++;if(k===N)break}if(b.p.gridview===true){I=b.p.treeANode>-1?b.p.treeANode:0;b.p.grouping?l.jqGrid("groupingRender",K,b.p.colModel.length):b.p.treeGrid===true&&I>0?a(b.rows[I]).after(F.join("")):a("#"+a.jgrid.jqID(b.p.id)+" tbody:first").append(F.join(""))}if(b.p.subGrid===
true)try{l.jqGrid("addSubGrid",x+H)}catch(da){}b.p.totaltime=new Date-i;if(k>0&&b.p.records===0)b.p.records=d;if(b.p.treeGrid===true)try{l.jqGrid("setTreeNode",I+1,k+I+1)}catch(R){}if(!b.p.treeGrid&&!b.p.scroll)b.grid.bDiv.scrollTop=0;b.p.reccount=k;b.p.treeANode=-1;b.p.userDataOnFooter&&l.jqGrid("footerData","set",b.p.userData,true);if(j){b.p.records=d;b.p.lastpage=Math.ceil(d/N)}f||b.updatepager(false,true);if(j)for(;k<d&&A[k];){g=A[k];y=a.jgrid.getAccessor(g,E);if(y===void 0){typeof E==="number"&&
b.p.colModel[E+x+D+H]!=null&&(y=a.jgrid.getAccessor(g,b.p.colModel[E+x+D+H].name));if(y===void 0){y=P+k;if(p.length===0&&c.cell){e=a.jgrid.getAccessor(g,c.cell)||g;y=e!=null&&e[E]!==void 0?e[E]:y}}}if(g){y=b.p.idPrefix+y;B=h;if(c.repeatitems){c.cell&&(g=a.jgrid.getAccessor(g,c.cell)||g);a.isArray(g)&&(B=v)}for(o=0;o<B.length;o++)G[b.p.colModel[o+x+D+H].name]=a.jgrid.getAccessor(g,B[o]);G._id_=a.jgrid.stripPref(b.p.idPrefix,y);b.p.data.push(G);b.p._index[G._id_]=b.p.data.length-1;G={}}k++}}},F=function(){function d(a){var b=
...
var c=b.p.multiSort?[]:"",e=[],f=false,g={},i=[],h=[],j,l,k;if(a.isArray(b.p.data)){var m=b.p.grouping?b.p.groupingView:false,n,o;a.each(b.p.colModel,function(){l=this.sorttype||"text";if(l==="date"||l==="datetime"){if(this.formatter&&typeof this.formatter==="string"&&this.formatter==="date"){j=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:a.jgrid.formatter.date.srcformat;k=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:a.jgrid.formatter.date.newformat}else j=
k=this.datefmt||"Y-m-d";g[this.name]={stype:l,srcfmt:j,newfmt:k}}else g[this.name]={stype:l,srcfmt:"",newfmt:""};if(b.p.grouping){o=0;for(n=m.groupField.length;o<n;o++)if(this.name===m.groupField[o]){var d=this.name;if(this.index)d=this.index;i[o]=g[d];h[o]=d}}if(b.p.multiSort){if(this.lso){c.push(this.name);d=this.lso.split("-");e.push(d[d.length-1])}}else if(!f&&(this.index===b.p.sortname||this.name===b.p.sortname)){c=this.name;f=true}});if(b.p.treeGrid)a(b).jqGrid("SortTree",c,b.p.sortorder,g[c].stype,
...
g[b.p.postData.searchField])}catch(t){}}if(b.p.grouping)for(o=0;o<n;o++)p.orderBy(h[o],m.groupOrder[o],i[o].stype,i[o].srcfmt);b.p.multiSort?a.each(c,function(a){p.orderBy(this,e[a],g[this].stype,g[this].srcfmt)}):c&&b.p.sortorder&&f&&(b.p.sortorder.toUpperCase()==="DESC"?p.orderBy(b.p.sortname,"d",g[c].stype,g[c].srcfmt):p.orderBy(b.p.sortname,"a",g[c].stype,g[c].srcfmt));var r=p.select(),s=parseInt(b.p.rowNum,10),w=r.length,x=parseInt(b.p.page,10),D=Math.ceil(w/s),u={},r=r.slice((x-1)*s,x*s),g=
p=null;u[b.p.localReader.total]=D;u[b.p.localReader.page]=x;u[b.p.localReader.records]=w;u[b.p.localReader.root]=r;u[b.p.localReader.userdata]=b.p.userData;r=null;return u}}},v=function(){b.grid.hDiv.loading=true;if(!b.p.hiddengrid)switch(b.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(b.p.id)).show();break;case "block":a("#lui_"+a.jgrid.jqID(b.p.id)).show();a("#load_"+a.jgrid.jqID(b.p.id)).show()}},L=function(){b.grid.hDiv.loading=false;switch(b.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(b.p.id)).hide();
break;case "block":a("#lui_"+a.jgrid.jqID(b.p.id)).hide();a("#load_"+a.jgrid.jqID(b.p.id)).hide()}},C=function(d){if(!b.grid.hDiv.loading){var c=b.p.scroll&&d===false,e={},f,g=b.p.prmNames;if(b.p.page<=0)b.p.page=1;if(g.search!==null)e[g.search]=b.p.search;g.nd!==null&&(e[g.nd]=(new Date).getTime());if(g.rows!==null)e[g.rows]=b.p.rowNum;if(g.page!==null)e[g.page]=b.p.page;if(g.sort!==null)e[g.sort]=b.p.sortname;if(g.order!==null)e[g.order]=b.p.sortorder;if(b.p.rowTotal!==null&&g.totalrows!==null)e[g.totalrows]=
b.p.rowTotal;var i=a.isFunction(b.p.loadComplete),h=i?b.p.loadComplete:null,j=0,d=d||1;if(d>1)if(g.npage!==null){e[g.npage]=d;j=d-1;d=1}else h=function(a){b.p.page++;b.grid.hDiv.loading=false;i&&b.p.loadComplete.call(b,a);C(d-1)};else g.npage!==null&&delete b.p.postData[g.npage];if(b.p.grouping){a(b).jqGrid("groupingSetup");var l=b.p.groupingView,k,m="";for(k=0;k<l.groupField.length;k++){var n=l.groupField[k];a.each(b.p.colModel,function(a,b){if(b.name===n&&b.index)n=b.index});m=m+(n+" "+l.groupOrder[k]+
...
c,e,f);d===1&&L()},beforeSend:function(d,c){var e=true;a.isFunction(b.p.loadBeforeSend)&&(e=b.p.loadBeforeSend.call(b,d,c));e===void 0&&(e=true);if(e===false)return false;v()}},a.jgrid.ajaxOptions,b.p.ajaxGridOptions));break;case "xmlstring":v();e=typeof b.p.datastr!=="string"?b.p.datastr:a.parseXML(b.p.datastr);x(e,b.grid.bDiv);a(b).triggerHandler("jqGridLoadComplete",[e]);i&&b.p.loadComplete.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);b.p.datatype="local";b.p.datastr=null;L();break;
case "jsonstring":v();e=typeof b.p.datastr==="string"?a.jgrid.parse(b.p.datastr):b.p.datastr;B(e,b.grid.bDiv);a(b).triggerHandler("jqGridLoadComplete",[e]);i&&b.p.loadComplete.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);b.p.datatype="local";b.p.datastr=null;L();break;case "local":case "clientside":v();b.p.datatype="local";e=F();B(e,b.grid.bDiv,o,d>1,j);a(b).triggerHandler("jqGridLoadComplete",[e]);h&&h.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);c&&b.grid.populateVisible();
...
1)/this.value-0.5)+1;b.p.rowNum=this.value;b.p.pager&&a(".ui-pg-selbox",b.p.pager).val(this.value);b.p.toppager&&a(".ui-pg-selbox",b.p.toppager).val(this.value);C();return false});if(b.p.pgbuttons===true){a(".ui-pg-button","#"+h).hover(function(){if(a(this).hasClass("ui-state-disabled"))this.style.cursor="default";else{a(this).addClass("ui-state-hover");this.style.cursor="pointer"}},function(){if(!a(this).hasClass("ui-state-disabled")){a(this).removeClass("ui-state-hover");this.style.cursor="default"}});
a("#first"+a.jgrid.jqID(c)+", #prev"+a.jgrid.jqID(c)+", #next"+a.jgrid.jqID(c)+", #last"+a.jgrid.jqID(c)).click(function(){var a=o(b.p.page,1),d=o(b.p.lastpage,1),e=false,f=true,g=true,i=true,h=true;if(d===0||d===1)h=i=g=f=false;else if(d>1&&a>=1)if(a===1)g=f=false;else{if(a===d)h=i=false}else if(d>1&&a===0){h=i=false;a=d-1}if(!m(this.id))return false;if(this.id==="first"+c&&f){b.p.page=1;e=true}if(this.id==="prev"+c&&g){b.p.page=a-1;e=true}if(this.id==="next"+c&&i){b.p.page=a+1;e=true}if(this.id===
"last"+c&&h){b.p.page=d;e=true}e&&C();return false})}b.p.pginput===true&&a("input.ui-pg-input","#"+h).keypress(function(d){if((d.charCode||d.keyCode||0)===13){if(!m("user"))return false;a(this).val(o(a(this).val(),1));b.p.page=a(this).val()>0?a(this).val():b.p.page;C();return false}return this})},Y=function(d,c){var e,f="",g=b.p.colModel,i=false,h;h=b.p.frozenColumns?c:b.grid.headers[d].el;var j="";a("span.ui-grid-ico-sort",h).addClass("ui-state-disabled");a(h).attr("aria-selected","false");if(g[d].lso)if(g[d].lso===
...
w.call(b,true,false);b.grid.hDiv.scrollLeft=g}b.p.subGrid&&b.p.datatype==="local"&&a("td.sgexpanded","#"+a.jgrid.jqID(b.p.id)).each(function(){a(this).trigger("click")});C();b.p.lastsort=c;if(b.p.sortname!==d&&c)b.p.lastsort=c}}}},ba=function(d){d=a(b.grid.headers[d].el);d=[d.position().left+d.outerWidth()];b.p.direction==="rtl"&&(d[0]=b.p.width-d[0]);d[0]=d[0]-b.grid.bDiv.scrollLeft;d.push(a(b.grid.hDiv).position().top);d.push(a(b.grid.bDiv).offset().top-a(b.grid.hDiv).offset().top+a(b.grid.bDiv).height());
...
a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!0,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},b.p.jsonReader);b.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},b.p.localReader);b.p.scroll&&(b.p.pgbuttons=!1,b.p.pginput=!1,b.p.rowList=[]);b.p.data.length&&z();var D="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",
...
da+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+i+"'></span></span>");if(b.p.multiSort){P=b.p.sortname.split(",");for(g=0;g<P.length;g++)I=a.trim(P[g]).split(" "),P[g]=a.trim(I[0]),ha[g]=I[1]?a.trim(I[1]):b.p.sortorder||"asc"}for(g=0;g<this.p.colNames.length;g++)I=b.p.headertitles?' title="'+a.jgrid.stripHtml(b.p.colNames[g])+'"':"",D+="<th id='"+b.p.id+"_"+b.p.colModel[g].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+i+"'"+I+">",I=b.p.colModel[g].index||b.p.colModel[g].name,
D+="<div id='jqgh_"+b.p.id+"_"+b.p.colModel[g].name+"' "+H+">"+b.p.colNames[g],b.p.colModel[g].width=b.p.colModel[g].width?parseInt(b.p.colModel[g].width,10):150,"boolean"!==typeof b.p.colModel[g].title&&(b.p.colModel[g].title=!0),b.p.colModel[g].lso="",I===b.p.sortname&&(b.p.lastsort=g),b.p.multiSort&&(I=a.inArray(I,P),-1!==I&&(b.p.colModel[g].lso=ha[I])),D+=Q+"</div></th>";Q=null;a(this).append(D+"</tr></thead>");a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});
...
"false");X.push(this.id);if(d){a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id),b.grid.fbDiv)[b.p.useProp?"prop":"attr"]("checked",false);a("#"+a.jgrid.jqID(this.id),b.grid.fbDiv).removeClass("ui-state-highlight")}}});b.p.selrow=null;$=false}a(b).triggerHandler("jqGridSelectAll",[$?b.p.selarrrow:X,$]);a.isFunction(b.p.onSelectAll)&&b.p.onSelectAll.call(b,$?b.p.selarrrow:X,$)})}!0===b.p.autowidth&&(D=a(m).innerWidth(),b.p.width=0<D?D:"nw");(function(){var d=0,c=a.jgrid.cell_width?0:o(b.p.cellLayout,
0),f=0,g,i=o(b.p.scrollOffset,0),j,l=false,k,m=0,n;a.each(b.p.colModel,function(){if(this.hidden===void 0)this.hidden=false;if(b.p.grouping&&b.p.autowidth){var e=a.inArray(this.name,b.p.groupingView.groupField);if(e>=0&&b.p.groupingView.groupColumnShow.length>e)this.hidden=!b.p.groupingView.groupColumnShow[e]}this.widthOrg=j=o(this.width,0);if(this.hidden===false){d=d+(j+c);this.fixed?m=m+(j+c):f++}});if(isNaN(b.p.width))b.p.width=d+(b.p.shrinkToFit===false&&!isNaN(b.p.height)?i:0);e.width=b.p.width;
b.p.tblwidth=d;if(b.p.shrinkToFit===false&&b.p.forceFit===true)b.p.forceFit=false;if(b.p.shrinkToFit===true&&f>0){k=e.width-c*f-m;if(!isNaN(b.p.height)){k=k-i;l=true}d=0;a.each(b.p.colModel,function(a){if(this.hidden===false&&!this.fixed){this.width=j=Math.round(k*this.width/(b.p.tblwidth-c*f-m));d=d+j;g=a}});n=0;l?e.width-m-(d+c*f)!==i&&(n=e.width-m-(d+c*f)-i):!l&&Math.abs(e.width-m-(d+c*f))!==1&&(n=e.width-m-(d+c*f));b.p.colModel[g].width=b.p.colModel[g].width+n;b.p.tblwidth=d+n+c*f+m;if(b.p.tblwidth>
b.p.width){b.p.colModel[g].width=b.p.colModel[g].width-(b.p.tblwidth-parseInt(b.p.width,10));b.p.tblwidth=b.p.width}}})();a(m).css("width",e.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+b.p.id+"'>&#160;</div>");a(j).css("width",e.width+"px");var D=a("thead:first",b).get(0),U="";b.p.footerrow&&(U+="<table role='grid' style='width:"+b.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+
i+"'>");var j=a("tr:first",D),aa="<tr class='jqgfirstrow' role='row' style='height:auto'>";b.p.disableClick=!1;a("th",j).each(function(d){E=b.p.colModel[d].width;if(b.p.colModel[d].resizable===void 0)b.p.colModel[d].resizable=true;if(b.p.colModel[d].resizable){T=document.createElement("span");a(T).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+i).css("cursor","col-resize");a(this).addClass(b.p.resizeclass)}else T="";a(this).css("width",E+"px").prepend(T);var c="";if(b.p.colModel[d].hidden){a(this).css("display",
...
this).show();a("div span.ui-icon-"+b.p.colModel[d].lso,this).removeClass("ui-state-disabled")}}else if(b.p.viewsortcols[0]){a("div span.s-ico",this).show();d===b.p.lastsort&&a("div span.ui-icon-"+b.p.sortorder,this).removeClass("ui-state-disabled")}else if(d===b.p.lastsort){a("div span.s-ico",this).show();a("div span.ui-icon-"+b.p.sortorder,this).removeClass("ui-state-disabled")}b.p.footerrow&&(U=U+("<td role='gridcell' "+n(d,0,"",null,"",false)+">&#160;</td>"))}).mousedown(function(d){if(a(d.target).closest("th>span.ui-jqgrid-resize").length===
...
"' cellspacing='0' cellpadding='0' border='0'></table>").append(D),R=b.p.caption&&!0===b.p.hiddengrid?!0:!1;g=a("<div class='ui-jqgrid-hbox"+("rtl"===i?"-rtl":"")+"'></div>");D=null;e.hDiv=document.createElement("div");a(e.hDiv).css({width:e.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(g);a(g).append(j);j=null;R&&a(e.hDiv).hide();b.p.pager&&("string"===typeof b.p.pager?"#"!==b.p.pager.substr(0,1)&&(b.p.pager="#"+b.p.pager):b.p.pager="#"+a(b.p.pager).attr("id"),a(b.p.pager).css({width:e.width+
...
"";if(m=m+(b.p.toppager?m?","+b.p.toppager:b.p.toppager:"")){l=a.jgrid.formatter.integer||{};e=o(b.p.page);f=o(b.p.lastpage);a(".selbox",m)[this.p.useProp?"prop":"attr"]("disabled",false);if(b.p.pginput===true){a(".ui-pg-input",m).val(b.p.page);i=b.p.toppager?"#sp_1"+k+",#sp_1"+n:"#sp_1"+k;a(i).html(a.fmatter?a.fmatter.util.NumberFormat(b.p.lastpage,l):b.p.lastpage)}if(b.p.viewrecords)if(b.p.reccount===0)a(".ui-paging-info",m).html(b.p.emptyrecords);else{i=g+1;j=b.p.records;if(a.fmatter){i=a.fmatter.util.NumberFormat(i,
l);h=a.fmatter.util.NumberFormat(h,l);j=a.fmatter.util.NumberFormat(j,l)}a(".ui-paging-info",m).html(a.jgrid.format(b.p.recordtext,i,h,j))}if(b.p.pgbuttons===true){e<=0&&(e=f=0);if(e===1||e===0){a("#first"+k+", #prev"+k).addClass("ui-state-disabled").removeClass("ui-state-hover");b.p.toppager&&a("#first_t"+n+", #prev_t"+n).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{a("#first"+k+", #prev"+k).removeClass("ui-state-disabled");b.p.toppager&&a("#first_t"+n+", #prev_t"+n).removeClass("ui-state-disabled")}if(e===
f||e===0){a("#next"+k+", #last"+k).addClass("ui-state-disabled").removeClass("ui-state-hover");b.p.toppager&&a("#next_t"+n+", #last_t"+n).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{a("#next"+k+", #last"+k).removeClass("ui-state-disabled");b.p.toppager&&a("#next_t"+n+", #last_t"+n).removeClass("ui-state-disabled")}}}d===true&&b.p.rownumbers===true&&a(">td.jqgrid-rownum",b.rows).each(function(b){a(this).html(g+1+b)});c&&b.p.jqgdnd&&a(b).jqGrid("gridDnD","updateDnD");a(b).triggerHandler("jqGridGridComplete");
a.isFunction(b.p.gridComplete)&&b.p.gridComplete.call(b);a(b).triggerHandler("jqGridAfterGridComplete")};b.refreshIndex=z;b.setHeadCheckBox=O;b.constructTr=J;b.formatter=function(a,b,d,c,e){return p(a,b,d,c,e)};a.extend(e,{populate:C,emptyRows:w});this.grid=e;b.addXmlData=function(a){x(a,b.grid.bDiv)};b.addJSONData=function(a){B(a,b.grid.bDiv)};this.grid.cols=this.rows[0].cells;a(b).triggerHandler("jqGridInitGrid");a.isFunction(b.p.onInitGrid)&&b.p.onInitGrid.call(b);C();b.p.hiddengrid=!1}}}})};a.jgrid.extend({getGridParam:function(a){var e=
...
{title:a.jgrid.stripHtml(i)}:{},!0===g.p.treeGrid&&f===g.p.ExpandColumn?a("td[role='gridcell']:eq("+b+") > span:first",j).html(i).attr(h):a("td[role='gridcell']:eq("+b+")",j).html(i).attr(h))}),"local"===g.p.datatype){var o=a.jgrid.stripPref(g.p.idPrefix,c),n=g.p._index[o],l;if(g.p.treeGrid)for(l in g.p.treeReader)g.p.treeReader.hasOwnProperty(l)&&delete m[g.p.treeReader[l]];void 0!==n&&(g.p.data[n]=a.extend(!0,g.p.data[n],m));m=null}}catch(p){b=!1}b&&("string"===k?a(j).addClass(d):"object"===k&&
a(j).css(d),a(g).triggerHandler("jqGridAfterGridComplete"))});return b},addRowData:function(c,e,d,f){d||(d="last");var b=!1,h,g,i,j,k,m,o,n,l="",p,q,r,s,t,u;e&&(a.isArray(e)?(p=!0,d="last",q=c):(e=[e],p=!1),this.each(function(){var w=e.length;k=this.p.rownumbers===true?1:0;i=this.p.multiselect===true?1:0;j=this.p.subGrid===true?1:0;if(!p)if(c!==void 0)c=""+c;else{c=a.jgrid.randId();if(this.p.keyIndex!==false){q=this.p.colModel[this.p.keyIndex+i+j+k].name;e[0][q]!==void 0&&(c=e[0][q])}}r=this.p.altclass;
for(var z=0,J="",x={},B=a.isFunction(this.p.afterInsertRow)?true:false;z<w;){s=e[z];g=[];if(p){try{c=s[q];c===void 0&&(c=a.jgrid.randId())}catch(F){c=a.jgrid.randId()}J=this.p.altRows===true?(this.rows.length-1)%2===0?r:"":""}u=c;c=this.p.idPrefix+c;if(k){l=this.formatCol(0,1,"",null,c,true);g[g.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+l+">0</td>"}if(i){n='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+c+'" class="cbox"/>';l=this.formatCol(k,1,"",null,
c,true);g[g.length]='<td role="gridcell" '+l+">"+n+"</td>"}j&&(g[g.length]=a(this).jqGrid("addSubGridCell",i+k,1));for(o=i+j+k;o<this.p.colModel.length;o++){t=this.p.colModel[o];h=t.name;x[h]=s[h];n=this.formatter(c,a.jgrid.getAccessor(s,h),o,s);l=this.formatCol(o,1,n,s,c,x);g[g.length]='<td role="gridcell" '+l+">"+n+"</td>"}g.unshift(this.constructTr(c,false,J,x,s,false));g[g.length]="</tr>";if(this.rows.length===0)a("table:first",this.grid.bDiv).append(g.join(""));else switch(d){case "last":a(this.rows[this.rows.length-
1]).after(g.join(""));m=this.rows.length-1;break;case "first":a(this.rows[0]).after(g.join(""));m=1;break;case "after":(m=this.rows.namedItem(f))&&(a(this.rows[m.rowIndex+1]).hasClass("ui-subgrid")?a(this.rows[m.rowIndex+1]).after(g):a(m).after(g.join("")));m++;break;case "before":if(m=this.rows.namedItem(f)){a(m).before(g.join(""));m=m.rowIndex}m--}this.p.subGrid===true&&a(this).jqGrid("addSubGrid",i+k,m);this.p.records++;this.p.reccount++;a(this).triggerHandler("jqGridAfterInsertRow",[c,s,s]);B&&
this.p.afterInsertRow.call(this,c,s,s);z++;if(this.p.datatype==="local"){x[this.p.localReader.id]=u;this.p._index[u]=this.p.data.length;this.p.data.push(x);x={}}}this.p.altRows===true&&!p&&(d==="last"?(this.rows.length-1)%2===1&&a(this.rows[this.rows.length-1]).addClass(r):a(this.rows).each(function(b){b%2===1?a(this).addClass(r):a(this).removeClass(r)}));this.updatepager(true,true);b=true}));return b},footerData:function(c,e,d){function f(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0}
...
e,d){var f=[],b,h=0,g,i,j,e="boolean"!==typeof e?!1:e;void 0===d&&(d=!1);this.each(function(){var k=-1;if(this.grid&&(isNaN(c)?a(this.p.colModel).each(function(a){if(this.name===c)return k=a,!1}):k=parseInt(c,10),0<=k)){var m=this.rows.length,o=0;if(m&&0<m){for(;o<m;){if(a(this.rows[o]).hasClass("jqgrow")){try{b=a.unformat.call(this,a(this.rows[o].cells[k]),{rowId:this.rows[o].id,colModel:this.p.colModel[k]},k)}catch(n){b=a.jgrid.htmlDecode(this.rows[o].cells[k].innerHTML)}d?(j=parseFloat(b),h+=j,
void 0===i&&(i=g=j),g=Math.min(g,j),i=Math.max(i,j)):e?f.push({id:this.rows[o].id,value:b}):f.push(b)}o++}if(d)switch(d.toLowerCase()){case "sum":f=h;break;case "avg":f=h/m;break;case "count":f=m;break;case "min":f=g;break;case "max":f=i}}}});return f},clearGridData:function(c){return this.each(function(){if(this.grid){"boolean"!==typeof c&&(c=!1);if(this.p.deepempty)a("#"+a.jgrid.jqID(this.p.id)+" tbody:first tr:gt(0)").remove();else{var e=a("#"+a.jgrid.jqID(this.p.id)+" tbody:first tr:first")[0];
...
le:"<=",gt:">",ge:">=",bw:"^",bn:"!^","in":"=",ni:"!=",ew:"|",en:"!@",cn:"~",nc:"!~",nu:"#",nn:"!#"}},a.jgrid.search,c||{});return this.each(function(){var e=this;if(!this.ftoolbar){var d=function(){var b={},d=0,f,h,m={},o;a.each(e.p.colModel,function(){var l=a("#gs_"+a.jgrid.jqID(this.name),!0===this.frozen&&!0===e.p.frozenColumns?e.grid.fhDiv:e.grid.hDiv);h=this.index||this.name;o=c.searchOperators?l.parent().prev().children("a").attr("soper")||c.defaultSearch:this.searchoptions&&this.searchoptions.sopt?
this.searchoptions.sopt[0]:"select"===this.stype?"eq":c.defaultSearch;if((f="custom"===this.stype&&a.isFunction(this.searchoptions.custom_value)&&0<l.length&&"SPAN"===l[0].nodeName.toUpperCase()?this.searchoptions.custom_value.call(e,l.children(".customelement:first"),"get"):l.val())||"nu"===o||"nn"===o)b[h]=f,m[h]=o,d++;else try{delete e.p.postData[h]}catch(n){}});var n=0<d?!0:!1;if(!0===c.stringResult||"local"===e.p.datatype){var l='{"groupOp":"'+c.groupOp+'","rules":[',p=0;a.each(b,function(a,
...
(r=c.beforeSearch.call(e));r||a(e).jqGrid("setGridParam",{search:n}).trigger("reloadGrid",[{page:1}]);q&&a(e).jqGrid("setGridParam",{url:q});a(e).triggerHandler("jqGridToolbarAfterSearch");a.isFunction(c.afterSearch)&&c.afterSearch.call(e)},f=function(b,f,h){a("#sopt_menu").remove();var f=parseInt(f,10),h=parseInt(h,10)+18,f='<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:'+(a(".ui-jqgrid-view").css("font-size")||"11px")+";left:"+f+"px;top:"+h+'px;">',h=a(b).attr("soper"),
k,m=[],o,n=0,l=a(b).attr("colname");for(k=e.p.colModel.length;n<k&&e.p.colModel[n].name!==l;)n++;n=e.p.colModel[n];l=a.extend({},n.searchoptions);l.sopt||(l.sopt=[],l.sopt[0]="select"===n.stype?"eq":c.defaultSearch);a.each(c.odata,function(){m.push(this.oper)});for(n=0;n<l.sopt.length;n++)o=a.inArray(l.sopt[n],m),-1!==o&&(k=h===c.odata[o].oper?"ui-state-highlight":"",f+='<li class="ui-menu-item '+k+'" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="'+c.odata[o].oper+
'" oper="'+c.operands[c.odata[o].oper]+'"><table cellspacing="0" cellpadding="0" border="0"><tr><td width="25px">'+c.operands[c.odata[o].oper]+"</td><td>"+c.odata[o].text+"</td></tr></table></a></li>");a("body").append(f+"</ul>");a("#sopt_menu").addClass("ui-menu ui-widget ui-widget-content ui-corner-all");a("#sopt_menu > li > a").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}).click(function(){var f=a(this).attr("value"),i=a(this).attr("oper");
a(e).triggerHandler("jqGridToolbarSelectOper",[f,i,b]);a("#sopt_menu").hide();a(b).text(i).attr("soper",f);if(c.autosearch===true){i=a(b).parent().next().children()[0];(a(i).val()||f==="nu"||f==="nn")&&d()}})},b=a("<tr class='ui-search-toolbar' role='rowheader'></tr>"),h;a.each(e.p.colModel,function(){var f=this,i,j;j="";var k="=",m,o=a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"+e.p.direction+"'></th>"),n=a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"),
l=a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td></tr></table>");!0===this.hidden&&a(o).css("display","none");this.search=!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");i=a.extend({},this.searchoptions||{});if(this.search){if(c.searchOperators){j=i.sopt?i.sopt[0]:"select"===f.stype?"eq":c.defaultSearch;for(m=0;m<c.odata.length;m++)if(c.odata[m].oper===j){k=c.operands[j]||"";break}j="<a title='"+(null!=i.searchtitle?
i.searchtitle:c.operandTitle)+"' style='padding-right: 0.5em;' soper='"+j+"' class='soptclass' colname='"+this.name+"'>"+k+"</a>"}a("td:eq(0)",l).append(j);switch(this.stype){case "select":if(j=this.surl||i.dataUrl)a.ajax(a.extend({url:j,dataType:"html",success:function(b){if(i.buildSelect!==void 0){if(b=i.buildSelect(b)){a("td:eq(1)",l).append(b);a(n).append(l)}}else{a("td:eq(1)",l).append(b);a(n).append(l)}i.defaultValue!==void 0&&a("select",n).val(i.defaultValue);a("select",n).attr({name:f.index||
f.name,id:"gs_"+f.name});i.attr&&a("select",n).attr(i.attr);a("select",n).css({width:"100%"});a.jgrid.bindEv.call(e,a("select",n)[0],i);c.autosearch===true&&a("select",n).change(function(){d();return false});b=null}},a.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{}));else{var p,q,r;f.searchoptions?(p=void 0===f.searchoptions.value?"":f.searchoptions.value,q=void 0===f.searchoptions.separator?":":f.searchoptions.separator,r=void 0===f.searchoptions.delimiter?";":f.searchoptions.delimiter):f.editoptions&&
(p=void 0===f.editoptions.value?"":f.editoptions.value,q=void 0===f.editoptions.separator?":":f.editoptions.separator,r=void 0===f.editoptions.delimiter?";":f.editoptions.delimiter);if(p){k=document.createElement("select");k.style.width="100%";a(k).attr({name:f.index||f.name,id:"gs_"+f.name});var s;if("string"===typeof p){j=p.split(r);for(s=0;s<j.length;s++)p=j[s].split(q),r=document.createElement("option"),r.value=p[0],r.innerHTML=p[1],k.appendChild(r)}else if("object"===typeof p)for(s in p)p.hasOwnProperty(s)&&
(r=document.createElement("option"),r.value=s,r.innerHTML=p[s],k.appendChild(r));void 0!==i.defaultValue&&a(k).val(i.defaultValue);i.attr&&a(k).attr(i.attr);a.jgrid.bindEv.call(e,k,i);a("td:eq(1)",l).append(k);a(n).append(l);!0===c.autosearch&&a(k).change(function(){d();return false})}}break;case "text":q=void 0!==i.defaultValue?i.defaultValue:"";a("td:eq(1)",l).append("<input type='text' style='width:100%;padding:0px;' name='"+(f.index||f.name)+"' id='gs_"+f.name+"' value='"+q+"'/>");a(n).append(l);
i.attr&&a("input",n).attr(i.attr);a.jgrid.bindEv.call(e,a("input",n)[0],i);!0===c.autosearch&&(c.searchOnEnter?a("input",n).keypress(function(a){if((a.charCode||a.keyCode||0)===13){d();return false}return this}):a("input",n).keydown(function(a){switch(a.which){case 13:return false;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:h&&clearTimeout(h);h=setTimeout(function(){d()},500)}}));break;case "custom":a("td:eq(1)",l).append("<span style='width:95%;padding:0px;' name='"+(f.index||
f.name)+"' id='gs_"+f.name+"'/>");a(n).append(l);try{if(a.isFunction(i.custom_element)){var t=i.custom_element.call(e,void 0!==i.defaultValue?i.defaultValue:"",i);if(t)t=a(t).addClass("customelement"),a(n).find(">span").append(t);else throw"e2";}else throw"e1";}catch(u){"e1"===u&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===u?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof u?u:u.message,a.jgrid.edit.bClose)}}}a(o).append(n);a(b).append(o);c.searchOperators||a("td:eq(0)",l).hide()});a("table thead",e.grid.hDiv).append(b);c.searchOperators&&(a(".soptclass").click(function(b){var d=a(this).offset();f(this,d.left,d.top);b.stopPropagation()}),a("body").on("click",function(b){"soptclass"!==b.target.className&&a("#sopt_menu").hide()}));this.ftoolbar=!0;this.triggerToolbar=d;this.clearToolbar=
...
case "text":c.val(b);if(b!==void 0){d[h]=b;f++}else try{delete e.p.postData[h]}catch(l){}break;case "custom":a.isFunction(this.searchoptions.custom_value)&&c.length>0&&c[0].nodeName.toUpperCase()==="SPAN"&&this.searchoptions.custom_value.call(e,c.children(".customelement:first"),"set",b)}});var m=f>0?true:false;if(c.stringResult===true||e.p.datatype==="local"){var o='{"groupOp":"'+c.groupOp+'","rules":[',n=0;a.each(d,function(a,b){n>0&&(o=o+",");o=o+('{"field":"'+a+'",');o=o+'"op":"eq",';o=o+('"data":"'+
(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}');n++});o=o+"]}";a.extend(e.p.postData,{filters:o});a.each(["searchField","searchString","searchOper"],function(a,b){e.p.postData.hasOwnProperty(b)&&delete e.p.postData[b]})}else a.extend(e.p.postData,d);var l;if(e.p.searchurl){l=e.p.url;a(e).jqGrid("setGridParam",{url:e.p.searchurl})}var p=a(e).triggerHandler("jqGridToolbarBeforeClear")==="stop"?true:false;!p&&a.isFunction(c.beforeClear)&&(p=c.beforeClear.call(e));p||b&&a(e).jqGrid("setGridParam",
...
function(a){return i(this,a,"jqmShow")};a.fn.jqmShow=function(b){return this.each(function(){a.jqm.open(this._jqm,b)})};a.fn.jqmHide=function(b){return this.each(function(){a.jqm.close(this._jqm,b)})};a.jqm={hash:{},open:function(c,g){var i=e[c],o=i.c,n="."+o.closeClass,l=parseInt(i.w.css("z-index")),l=0<l?l:3E3,p=a("<div></div>").css({height:"100%",width:"100%",position:"fixed",left:0,top:0,"z-index":l-1,opacity:o.overlay/100});if(i.a)return f;i.t=g;i.a=!0;i.w.css("z-index",l);o.modal?(d[0]||setTimeout(function(){h("bind")},
1),d.push(c)):0<o.overlay?o.closeoverlay&&i.w.jqmAddClose(p):p=f;i.o=p?p.addClass(o.overlayClass).prependTo("body"):f;o.ajax?(l=o.target||i.w,p=o.ajax,l="string"==typeof l?a(l,i.w):a(l),p="@"==p.substr(0,1)?a(g).attr(p.substring(1)):p,l.html(o.ajaxText).load(p,function(){o.onLoad&&o.onLoad.call(this,i);n&&i.w.jqmAddClose(a(n,i.w));b(i)})):n&&i.w.jqmAddClose(a(n,i.w));o.toTop&&i.o&&i.w.before('<span id="jqmP'+i.w[0]._jqm+'"></span>').insertAfter(i.o);o.onShow?o.onShow(i):i.w.show();b(i);return f},
...
void 0===e.size&&(e.size=c?3:1);c&&(f=d.split(","),f=a.map(f,function(b){return a.trim(b)}));"function"===typeof e.value&&(e.value=e.value());var m,o,n=void 0===e.separator?":":e.separator,b=void 0===e.delimiter?";":e.delimiter;if("string"===typeof e.value){m=e.value.split(b);for(k=0;k<m.length;k++){o=m[k].split(n);2<o.length&&(o[1]=a.map(o,function(a,b){if(b>0)return a}).join(n));b=document.createElement("option");b.setAttribute("role","option");b.value=o[0];b.innerHTML=o[1];g.appendChild(b);if(!c&&
(a.trim(o[0])===a.trim(d)||a.trim(o[1])===a.trim(d)))b.selected="selected";if(c&&(-1<a.inArray(a.trim(o[1]),f)||-1<a.inArray(a.trim(o[0]),f)))b.selected="selected"}}else if("object"===typeof e.value)for(k in n=e.value,n)if(n.hasOwnProperty(k)){b=document.createElement("option");b.setAttribute("role","option");b.value=k;b.innerHTML=n[k];g.appendChild(b);if(!c&&(a.trim(k)===a.trim(d)||a.trim(n[k])===a.trim(d)))b.selected="selected";if(c&&(-1<a.inArray(a.trim(n[k]),f)||-1<a.inArray(a.trim(k),f)))b.selected=
"selected"}h(g,e,["value"])}break;case "text":case "password":case "button":k="button"===c?"button":"textbox";g=document.createElement("input");g.type=c;g.value=d;h(g,e);"button"!==c&&(f?e.size||a(g).css({width:"98%"}):e.size||(e.size=20));a(g).attr("role",k);break;case "image":case "file":g=document.createElement("input");g.type=c;h(g,e);break;case "custom":g=document.createElement("span");try{if(a.isFunction(e.custom_element))if(n=e.custom_element.call(i,d,e))n=a(n).addClass("customelement").attr({id:e.id,
name:e.name}),a(g).empty().append(n);else throw"e2";else throw"e1";}catch(l){"e1"===l&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===l?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof l?l:l.message,a.jgrid.edit.bClose)}}return g},checkDate:function(a,e){var d={},f,a=a.toLowerCase();f=-1!==a.indexOf("/")?
...
function(){if(b.groups===void 0)b.groups=[];b.groups.push({groupOp:f.groupOps[0].op,rules:[],groups:[]});c.reDraw();c.onchange();return false}));i.append(h);if(!0===this.p.ruleButtons){var h=a("<input type='button' value='+' title='Add rule' class='add-rule ui-add'/>"),u;h.bind("click",function(){if(b.rules===void 0)b.rules=[];for(e=0;e<c.p.columns.length;e++){var d=c.p.columns[e].search===void 0?true:c.p.columns[e].search,f=c.p.columns[e].hidden===true;if(c.p.columns[e].searchoptions.searchhidden===
true&&d||d&&!f){u=c.p.columns[e];break}}d=u.searchoptions.sopt?u.searchoptions.sopt:c.p.sopt?c.p.sopt:a.inArray(u.searchtype,c.p.strarr)!==-1?c.p.stropts:c.p.numopts;b.rules.push({field:u.name,op:d[0],data:""});c.reDraw();return false});i.append(h)}null!==d&&(h=a("<input type='button' value='-' title='Delete group' class='delete-group'/>"),i.append(h),h.bind("click",function(){for(e=0;e<d.groups.length;e++)if(d.groups[e]===b){d.groups.splice(e,1);break}c.reDraw();c.onchange();return false}));if(void 0!==
b.groups)for(e=0;e<b.groups.length;e++)i=a("<tr></tr>"),g.append(i),h=a("<td class='first'></td>"),i.append(h),h=a("<td colspan='4'></td>"),h.append(this.createTableForGroup(b.groups[e],b)),i.append(h);void 0===b.groupOp&&(b.groupOp=c.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)g.append(this.createTableRowForRule(b.rules[e],b));return g};this.createTableRowForRule=function(b,d){var c=this,g=j(),h=a("<tr></tr>"),k,r,s,t,u="",w;h.append("<td class='first'></td>");var z=a("<td class='columns'></td>");
...
for(k=z=0;k<c.p.columns.length;k++){w=void 0===c.p.columns[k].search?!0:c.p.columns[k].search;var F=!0===c.p.columns[k].hidden;if(!0===c.p.columns[k].searchoptions.searchhidden&&w||w&&!F)w="",b.field===c.p.columns[k].name&&(w=" selected='selected'",z=k),u+="<option value='"+c.p.columns[k].name+"'"+w+">"+c.p.columns[k].label+"</option>"}J.append(u);u=a("<td class='operators'></td>");h.append(u);t=f.columns[z];t.searchoptions.id=a.jgrid.randId();e&&"text"===t.inputtype&&!t.searchoptions.size&&(t.searchoptions.size=
10);z=a.jgrid.createEl.call(g,t.inputtype,t.searchoptions,b.data,!0,c.p.ajaxSelectOptions,!0);if("nu"===b.op||"nn"===b.op)a(z).attr("readonly","true"),a(z).attr("disabled","true");var v=a("<select class='selectopts'></select>");u.append(v);v.bind("change",function(){b.op=a(v).val();s=a(this).parents("tr:first");var d=a(".input-elm",s)[0];if(b.op==="nu"||b.op==="nn"){b.data="";d.value="";d.setAttribute("readonly","true");d.setAttribute("disabled","true")}else{d.removeAttribute("readonly");d.removeAttribute("disabled")}c.onchange()});
r=t.searchoptions.sopt?t.searchoptions.sopt:c.p.sopt?c.p.sopt:-1!==a.inArray(t.searchtype,c.p.strarr)?c.p.stropts:c.p.numopts;u="";a.each(c.p.ops,function(){B.push(this.oper)});for(k=0;k<r.length;k++)x=a.inArray(r[k],B),-1!==x&&(w=b.op===c.p.ops[x].oper?" selected='selected'":"",u+="<option value='"+c.p.ops[x].oper+"'"+w+">"+c.p.ops[x].text+"</option>");v.append(u);u=a("<td class='data'></td>");h.append(u);u.append(z);a.jgrid.bindEv.call(g,z,t.searchoptions);a(z).addClass("input-elm").bind("change",
function(){b.data=t.inputtype==="custom"?t.searchoptions.custom_value.call(g,a(this).children(".customelement:first"),"get"):a(this).val();c.onchange()});u=a("<td></td>");h.append(u);!0===this.p.ruleButtons&&(z=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),u.append(z),z.bind("click",function(){for(k=0;k<d.rules.length;k++)if(d.rules[k]===b){d.rules.splice(k,1);break}c.reDraw();c.onchange();return false}));return h};this.getStringForGroup=function(a){var b="(",
...
typeof i&&(i=a.jgrid.parse(i));!0===c.recreateFilter&&a("#"+a.jgrid.jqID(g.themodal)).remove();if(void 0!==a("#"+a.jgrid.jqID(g.themodal))[0])d(a("#fbox_"+a.jgrid.jqID(+f.p.id)));else{var j=a("<div><div id='"+b+"' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_"+a.jgrid.jqID(f.p.id)),k="left",m="";"rtl"===f.p.direction&&(k="right",m=" style='text-align:left'",j.attr("dir","rtl"));var o=a.extend([],f.p.colModel),n="<a href='javascript:void(0)' id='"+b+"_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>"+
c.Find+"</a>",l="<a href='javascript:void(0)' id='"+b+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+c.Reset+"</a>",p="",q="",r,s=!1,t=-1;c.showQuery&&(p="<a href='javascript:void(0)' id='"+b+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");c.columns.length?(o=c.columns,t=0,r=o[0].index||o[0].name):a.each(o,function(a,
b){if(!b.label)b.label=f.p.colNames[a];if(!s){var d=b.search===void 0?true:b.search,c=b.hidden===true;if(b.searchoptions&&b.searchoptions.searchhidden===true&&d||d&&!c){s=true;r=b.index||b.name;t=a}}});if(!i&&r||!1===c.multipleSearch){var u="eq";0<=t&&o[t].searchoptions&&o[t].searchoptions.sopt?u=o[t].searchoptions.sopt[0]:c.sopt&&c.sopt.length&&(u=c.sopt[0]);i={groupOp:"AND",rules:[{field:r,op:u,data:""}]}}s=!1;c.tmplNames&&c.tmplNames.length&&(s=!0,q=c.tmplLabel,q+="<select class='ui-template'>",
q+="<option value='default'>Default</option>",a.each(c.tmplNames,function(a,b){q=q+("<option value='"+a+"'>"+b+"</option>")}),q+="</select>");k="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+b+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+k+"'>"+l+q+"</td><td class='EditButton' "+m+">"+p+n+"</td></tr></tbody></table>";b=a.jgrid.jqID(b);a("#"+b).jqFilter({columns:o,filter:c.loadDefaults?
...
a.each(l.p.colModel,function(){if(this.name===d&&this.editoptions&&a.isFunction(this.editoptions.custom_value)){try{if(v[d]=this.editoptions.custom_value.call(l,a("#"+a.jgrid.jqID(d),s),"get"),void 0===v[d])throw"e1";}catch(b){"e1"===b?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,b.message,a.jgrid.edit.bClose)}return!0}})}else{switch(a(this).get(0).type){case "checkbox":a(this).is(":checked")?
v[this.name]=a(this).val():(b=a(this).attr("offval"),v[this.name]=b);break;case "select-one":v[this.name]=a("option:selected",this).val();break;case "select-multiple":v[this.name]=a(this).val();v[this.name]=v[this.name]?v[this.name].join(","):"";a("option:selected",this).each(function(b,d){a(d).text()});break;case "password":case "text":case "textarea":case "button":v[this.name]=a(this).val()}l.p.autoencode&&(v[this.name]=a.jgrid.htmlEncode(v[this.name]))}});return!0}function b(b,d,e,f){var g,i,h,
j=0,k,m,o,n=[],p=!1,t="",s;for(s=1;s<=f;s++)t+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==b&&(p=a(d).jqGrid("getInd",b));a(d.p.colModel).each(function(s){g=this.name;m=(i=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";if("cb"!==g&&"subgrid"!==g&&!0===this.editable&&"rn"!==g){if(!1===p)k="";else if(g===d.p.ExpandColumn&&!0===d.p.treeGrid)k=a("td[role='gridcell']:eq("+s+")",d.rows[p]).text();else{try{k=a.unformat.call(d,
a("td[role='gridcell']:eq("+s+")",d.rows[p]),{rowId:b,colModel:this},s)}catch(r){k=this.edittype&&"textarea"===this.edittype?a("td[role='gridcell']:eq("+s+")",d.rows[p]).text():a("td[role='gridcell']:eq("+s+")",d.rows[p]).html()}if(!k||"&nbsp;"===k||"&#160;"===k||1===k.length&&160===k.charCodeAt(0))k=""}var x=a.extend({},this.editoptions||{},{id:g,name:g}),u=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),w=parseInt(u.rowpos,10)||j+1,v=parseInt(2*(parseInt(u.colpos,
10)||1),10);"_empty"===b&&x.defaultValue&&(k=a.isFunction(x.defaultValue)?x.defaultValue.call(l):x.defaultValue);this.edittype||(this.edittype="text");l.p.autoencode&&(k=a.jgrid.htmlDecode(k));o=a.jgrid.createEl.call(l,this.edittype,x,k,!1,a.extend({},a.jgrid.ajaxOptions,d.p.ajaxSelectOptions||{}));if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)c[l.p.id]._savedData[g]=k;a(o).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(o).addClass("ui-widget-content ui-corner-all");
h=a(e).find("tr[rowpos="+w+"]");if(u.rowabove){var B=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+u.rowcontent+"</td></tr>");a(e).append(B);B[0].rp=w}0===h.length&&(h=a("<tr "+m+" rowpos='"+w+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(h).append(t),a(e).append(h),h[0].rp=w);a("td:eq("+(v-2)+")",h[0]).html(void 0===u.label?d.p.colNames[s]:u.label);a("td:eq("+(v-1)+")",h[0]).append(u.elmprefix).append(o).append(u.elmsuffix);a.isFunction(x.custom_value)&&"_empty"!==b&&x.custom_value.call(l,
a("#"+g,"#"+q),"set",k);a.jgrid.bindEv.call(l,o,x);n[j]=s;j++}});if(0<j&&(s=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+d.p.id+"_id' value='"+b+"'/></td></tr>"),s[0].rp=j+999,a(e).append(s),c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate))c[l.p.id]._savedData[d.p.id+"_id"]=b;return n}function h(b,d,e){var f,g=0,i,h,j,k,m;if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)c[l.p.id]._savedData=
{},c[l.p.id]._savedData[d.p.id+"_id"]=b;var o=d.p.colModel;if("_empty"===b)a(o).each(function(){f=this.name;j=a.extend({},this.editoptions||{});if((h=a("#"+a.jgrid.jqID(f),"#"+e))&&h.length&&null!==h[0])if(k="",j.defaultValue?(k=a.isFunction(j.defaultValue)?j.defaultValue.call(l):j.defaultValue,"checkbox"===h[0].type?(m=k.toLowerCase(),0>m.search(/(false|f|0|no|n|off|undefined)/i)&&""!==m?(h[0].checked=!0,h[0].defaultChecked=!0,h[0].value=k):(h[0].checked=!1,h[0].defaultChecked=!1)):h.val(k)):"checkbox"===
h[0].type?(h[0].checked=!1,h[0].defaultChecked=!1,k=a(h).attr("offval")):h[0].type&&"select"===h[0].type.substr(0,6)?h[0].selectedIndex=0:h.val(k),!0===c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)c[l.p.id]._savedData[f]=k}),a("#id_g","#"+e).val(b);else{var n=a(d).jqGrid("getInd",b,!0);n&&(a('td[role="gridcell"]',n).each(function(h){f=o[h].name;if("cb"!==f&&"subgrid"!==f&&"rn"!==f&&!0===o[h].editable){if(f===d.p.ExpandColumn&&!0===d.p.treeGrid)i=a(this).text();else try{i=a.unformat.call(d,a(this),
{rowId:b,colModel:o[h]},h)}catch(j){i="textarea"===o[h].edittype?a(this).text():a(this).html()}l.p.autoencode&&(i=a.jgrid.htmlDecode(i));if(!0===c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)c[l.p.id]._savedData[f]=i;f=a.jgrid.jqID(f);switch(o[h].edittype){case "password":case "text":case "button":case "image":case "textarea":if("&nbsp;"===i||"&#160;"===i||1===i.length&&160===i.charCodeAt(0))i="";a("#"+f,"#"+e).val(i);break;case "select":var k=i.split(","),k=a.map(k,function(b){return a.trim(b)});
a("#"+f+" option","#"+e).each(function(){this.selected=!o[h].editoptions.multiple&&(a.trim(i)===a.trim(a(this).text())||k[0]===a.trim(a(this).text())||k[0]===a.trim(a(this).val()))?!0:o[h].editoptions.multiple?-1<a.inArray(a.trim(a(this).text()),k)||-1<a.inArray(a.trim(a(this).val()),k)?!0:!1:!1});break;case "checkbox":i=""+i;if(o[h].editoptions&&o[h].editoptions.value)if(o[h].editoptions.value.split(":")[0]===i)a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]({checked:!0,defaultChecked:!0});else a("#"+
f,"#"+e)[l.p.useProp?"prop":"attr"]({checked:!1,defaultChecked:!1});else i=i.toLowerCase(),0>i.search(/(false|f|0|no|n|off|undefined)/i)&&""!==i?(a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("checked",!0),a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("defaultChecked",!0)):(a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("checked",!1),a("#"+f,"#"+e)[l.p.useProp?"prop":"attr"]("defaultChecked",!1));break;case "custom":try{if(o[h].editoptions&&a.isFunction(o[h].editoptions.custom_value))o[h].editoptions.custom_value.call(l,
a("#"+f,"#"+e),"set",i);else throw"e1";}catch(m){"e1"===m?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,m.message,a.jgrid.edit.bClose)}}g++}}),0<g&&a("#id_g",s).val(b))}}function g(){a.each(l.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&v.hasOwnProperty(b.name)&&""===v[b.name]&&(v[b.name]="null")})}function i(){var b,e=[!0,"",""],f={},i=l.p.prmNames,j,k,m,o,n,
r=a(l).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+q),C]);r&&"object"===typeof r&&(v=r);a.isFunction(c[l.p.id].beforeCheckValues)&&(r=c[l.p.id].beforeCheckValues.call(l,v,a("#"+q),C))&&"object"===typeof r&&(v=r);for(m in v)if(v.hasOwnProperty(m)&&(e=a.jgrid.checkValues.call(l,v[m],m),!1===e[0]))break;g();e[0]&&(f=a(l).triggerHandler("jqGridAddEditClickSubmit",[c[l.p.id],v,C]),void 0===f&&a.isFunction(c[l.p.id].onclickSubmit)&&(f=c[l.p.id].onclickSubmit.call(l,c[l.p.id],v,C)||{}),e=a(l).triggerHandler("jqGridAddEditBeforeSubmit",
[v,a("#"+q),C]),void 0===e&&(e=[!0,"",""]),e[0]&&a.isFunction(c[l.p.id].beforeSubmit)&&(e=c[l.p.id].beforeSubmit.call(l,v,a("#"+q),C)));if(e[0]&&!c[l.p.id].processing){c[l.p.id].processing=!0;a("#sData",s+"_2").addClass("ui-state-active");k=i.oper;j=i.id;v[k]="_empty"===a.trim(v[l.p.id+"_id"])?i.addoper:i.editoper;v[k]!==i.addoper?v[j]=v[l.p.id+"_id"]:void 0===v[j]&&(v[j]=v[l.p.id+"_id"]);delete v[l.p.id+"_id"];v=a.extend(v,c[l.p.id].editData,f);if(!0===l.p.treeGrid)for(n in v[k]===i.addoper&&(o=
a(l).jqGrid("getGridParam","selrow"),v["adjacency"===l.p.treeGridModel?l.p.treeReader.parent_id_field:"parent_id"]=o),l.p.treeReader)l.p.treeReader.hasOwnProperty(n)&&(f=l.p.treeReader[n],v.hasOwnProperty(f)&&!(v[k]===i.addoper&&"parent_id_field"===n)&&delete v[f]);v[j]=a.jgrid.stripPref(l.p.idPrefix,v[j]);n=a.extend({url:c[l.p.id].url||a(l).jqGrid("getGridParam","editurl"),type:c[l.p.id].mtype,data:a.isFunction(c[l.p.id].serializeEditData)?c[l.p.id].serializeEditData.call(l,v):v,complete:function(f,
g){var m;v[j]=l.p.idPrefix+v[j];if(f.status>=300&&f.status!==304){e[0]=false;e[1]=a(l).triggerHandler("jqGridAddEditErrorTextFormat",[f,C]);e[1]=a.isFunction(c[l.p.id].errorTextFormat)?c[l.p.id].errorTextFormat.call(l,f,C):g+" Status: '"+f.statusText+"'. Error code: "+f.status}else{e=a(l).triggerHandler("jqGridAddEditAfterSubmit",[f,v,C]);e===void 0&&(e=[true,"",""]);e[0]&&a.isFunction(c[l.p.id].afterSubmit)&&(e=c[l.p.id].afterSubmit.call(l,f,v,C))}if(e[0]===false){a("#FormError>td",s).html(e[1]);
a("#FormError",s).show()}else{l.p.autoencode&&a.each(v,function(b,d){v[b]=a.jgrid.htmlDecode(d)});if(v[k]===i.addoper){e[2]||(e[2]=a.jgrid.randId());v[j]=e[2];c[l.p.id].reloadAfterSubmit?a(l).trigger("reloadGrid"):l.p.treeGrid===true?a(l).jqGrid("addChildNode",e[2],o,v):a(l).jqGrid("addRowData",e[2],v,d.addedrow);if(c[l.p.id].closeAfterAdd){l.p.treeGrid!==true&&a(l).jqGrid("setSelection",e[2]);a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose})}else c[l.p.id].clearAfterAdd&&
h("_empty",l,q)}else{if(c[l.p.id].reloadAfterSubmit){a(l).trigger("reloadGrid");c[l.p.id].closeAfterEdit||setTimeout(function(){a(l).jqGrid("setSelection",v[j])},1E3)}else l.p.treeGrid===true?a(l).jqGrid("setTreeRow",v[j],v):a(l).jqGrid("setRowData",v[j],v);c[l.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose})}if(a.isFunction(c[l.p.id].afterComplete)){b=f;setTimeout(function(){a(l).triggerHandler("jqGridAddEditAfterComplete",
[b,v,a("#"+q),C]);c[l.p.id].afterComplete.call(l,b,v,a("#"+q),C);b=null},500)}if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate){a("#"+q).data("disabled",false);if(c[l.p.id]._savedData[l.p.id+"_id"]!=="_empty")for(m in c[l.p.id]._savedData)c[l.p.id]._savedData.hasOwnProperty(m)&&v[m]&&(c[l.p.id]._savedData[m]=v[m])}}c[l.p.id].processing=false;a("#sData",s+"_2").removeClass("ui-state-active");try{a(":input:visible","#"+q)[0].focus()}catch(n){}}},a.jgrid.ajaxOptions,c[l.p.id].ajaxEditOptions);!n.url&&
!c[l.p.id].useDataProxy&&(a.isFunction(l.p.dataProxy)?c[l.p.id].useDataProxy=!0:(e[0]=!1,e[1]+=" "+a.jgrid.errors.nourl));e[0]&&(c[l.p.id].useDataProxy?(f=l.p.dataProxy.call(l,n,"set_"+l.p.id),void 0===f&&(f=[!0,""]),!1===f[0]?(e[0]=!1,e[1]=f[1]||"Error deleting the selected row!"):(n.data.oper===i.addoper&&c[l.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose}),n.data.oper===i.editoper&&c[l.p.id].closeAfterEdit&&
a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose}))):a.ajax(n))}!1===e[0]&&(a("#FormError>td",s).html(e[1]),a("#FormError",s).show())}function j(a,b){var d=!1,c;for(c in a)if(a.hasOwnProperty(c)&&a[c]!=b[c]){d=!0;break}return d}function k(){var b=!0;a("#FormError",s).hide();if(c[l.p.id].checkOnUpdate&&(v={},f(),L=j(v,c[l.p.id]._savedData)))a("#"+q).data("disabled",!0),a(".confirm","#"+t.themodal).show(),b=!1;return b}function m(){var b;
if("_empty"!==e&&void 0!==l.p.savedRow&&0<l.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<l.p.savedRow.length;b++)if(l.p.savedRow[b].id==e){a(l).jqGrid("restoreRow",e);break}}function o(b,d){var c=d[1].length-1;0===b?a("#pData",s+"_2").addClass("ui-state-disabled"):void 0!==d[1][b-1]&&a("#"+a.jgrid.jqID(d[1][b-1])).hasClass("ui-state-disabled")?a("#pData",s+"_2").addClass("ui-state-disabled"):a("#pData",s+"_2").removeClass("ui-state-disabled");b===c?a("#nData",s+"_2").addClass("ui-state-disabled"):
void 0!==d[1][b+1]&&a("#"+a.jgrid.jqID(d[1][b+1])).hasClass("ui-state-disabled")?a("#nData",s+"_2").addClass("ui-state-disabled"):a("#nData",s+"_2").removeClass("ui-state-disabled")}function n(){var b=a(l).jqGrid("getDataIDs"),d=a("#id_g",s).val();return[a.inArray(d,b),b]}var l=this;if(l.grid&&e){var p=l.p.id,q="FrmGrid_"+p,r="TblGrid_"+p,s="#"+a.jgrid.jqID(r),t={themodal:"editmod"+p,modalhead:"edithd"+p,modalcontent:"editcnt"+p,scrollelm:q},u=a.isFunction(c[l.p.id].beforeShowForm)?c[l.p.id].beforeShowForm:
!1,w=a.isFunction(c[l.p.id].afterShowForm)?c[l.p.id].afterShowForm:!1,z=a.isFunction(c[l.p.id].beforeInitData)?c[l.p.id].beforeInitData:!1,J=a.isFunction(c[l.p.id].onInitializeForm)?c[l.p.id].onInitializeForm:!1,x=!0,B=1,F=0,v,L,C,q=a.jgrid.jqID(q);"new"===e?(e="_empty",C="add",d.caption=c[l.p.id].addCaption):(d.caption=c[l.p.id].editCaption,C="edit");!0===d.recreateForm&&void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]&&a("#"+a.jgrid.jqID(t.themodal)).remove();var O=!0;d.checkOnUpdate&&d.jqModal&&!d.modal&&
(O=!1);if(void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]){x=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+a.jgrid.jqID(q)),C]);void 0===x&&(x=!0);x&&z&&(x=z.call(l,a("#"+q),C));if(!1===x)return;m();a(".ui-jqdialog-title","#"+a.jgrid.jqID(t.modalhead)).html(d.caption);a("#FormError",s).hide();c[l.p.id].topinfo?(a(".topinfo",s).html(c[l.p.id].topinfo),a(".tinfo",s).show()):a(".tinfo",s).hide();c[l.p.id].bottominfo?(a(".bottominfo",s+"_2").html(c[l.p.id].bottominfo),a(".binfo",s+"_2").show()):
a(".binfo",s+"_2").hide();h(e,l,q);"_empty"===e||!c[l.p.id].viewPagerButtons?a("#pData, #nData",s+"_2").hide():a("#pData, #nData",s+"_2").show();!0===c[l.p.id].processing&&(c[l.p.id].processing=!1,a("#sData",s+"_2").removeClass("ui-state-active"));!0===a("#"+q).data("disabled")&&(a(".confirm","#"+a.jgrid.jqID(t.themodal)).hide(),a("#"+q).data("disabled",!1));a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+q),C]);u&&u.call(l,a("#"+q),C);a("#"+a.jgrid.jqID(t.themodal)).data("onClose",c[l.p.id].onClose);
a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,jqM:!1,overlay:d.overlay,modal:d.modal,overlayClass:d.overlayClass});O||a("."+a.jgrid.jqID(d.overlayClass)).click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+q),C]);w&&w.call(l,a("#"+q),C)}else{var S=isNaN(d.dataheight)?d.dataheight:
d.dataheight+"px",x=isNaN(d.datawidth)?d.datawidth:d.datawidth+"px",S=a("<form name='FormPost' id='"+q+"' class='FormGrid' onSubmit='return false;' style='width:"+x+";overflow:auto;position:relative;height:"+S+";'></form>").data("disabled",!1),Y=a("<table id='"+r+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),x=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+q),C]);void 0===x&&(x=!0);x&&z&&(x=z.call(l,a("#"+q,C)));if(!1===x)return;m();a(l.p.colModel).each(function(){var a=
...
(z?W+x:x+W)+"</td><td class='EditButton'>"+ba+Z+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+c[l.p.id].bottominfo+"</td></tr>"),r=r+"</tbody></table>";if(0<F){var ca=[];a.each(a(Y)[0].rows,function(a,b){ca[a]=b});ca.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(ca,function(b,d){a("tbody",Y).append(d)})}d.gbox="#gbox_"+a.jgrid.jqID(p);var ea=!1;!0===d.closeOnEscape&&(d.closeOnEscape=!1,ea=!0);r=a("<div></div>").append(S).append(r);a.jgrid.createModal(t,
...
d.saveicon[2]+"'></span>");!0===d.closeicon[0]&&a("#cData",s+"_2").addClass("right"===d.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+d.closeicon[2]+"'></span>");if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)ba="<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+d.bYes+"</a>",W="<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+
d.bNo+"</a>",Z="<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+d.bExit+"</a>",r=d.zIndex||999,r++,a("<div class='"+d.overlayClass+" jqgrid-overlay confirm' style='z-index:"+r+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(r+1)+"'>"+d.saveData+"<br/><br/>"+ba+W+Z+"</div>").insertAfter("#"+q),a("#sNew","#"+a.jgrid.jqID(t.themodal)).click(function(){i();a("#"+q).data("disabled",false);
...
onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditInitializeForm",[a("#"+q),C]);J&&J.call(l,a("#"+q),C);"_empty"===e||!c[l.p.id].viewPagerButtons?a("#pData,#nData",s+"_2").hide():a("#pData,#nData",s+"_2").show();a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+q),C]);u&&u.call(l,a("#"+q),C);a("#"+a.jgrid.jqID(t.themodal)).data("onClose",c[l.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,overlay:d.overlay,
modal:d.modal,overlayClass:d.overlayClass});O||a("."+a.jgrid.jqID(d.overlayClass)).click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+q),C]);w&&w.call(l,a("#"+q),C);a(".fm-button","#"+a.jgrid.jqID(t.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",
s+"_2").click(function(){v={};a("#FormError",s).hide();f();if(v[l.p.id+"_id"]==="_empty")i();else if(d.checkOnSubmit===true)if(L=j(v,c[l.p.id]._savedData)){a("#"+q).data("disabled",true);a(".confirm","#"+a.jgrid.jqID(t.themodal)).show()}else i();else i();return false});a("#cData",s+"_2").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a("#nData",s+"_2").click(function(){if(!k())return false;
a("#FormError",s).hide();var b=n();b[0]=parseInt(b[0],10);if(b[0]!==-1&&b[1][b[0]+1]){a(l).triggerHandler("jqGridAddEditClickPgButtons",["next",a("#"+q),b[1][b[0]]]);var c;if(a.isFunction(d.onclickPgButtons)){c=d.onclickPgButtons.call(l,"next",a("#"+q),b[1][b[0]]);if(c!==void 0&&c===false)return false}if(a("#"+a.jgrid.jqID(b[1][b[0]+1])).hasClass("ui-state-disabled"))return false;h(b[1][b[0]+1],l,q);a(l).jqGrid("setSelection",b[1][b[0]+1]);a(l).triggerHandler("jqGridAddEditAfterClickPgButtons",["next",
a("#"+q),b[1][b[0]]]);a.isFunction(d.afterclickPgButtons)&&d.afterclickPgButtons.call(l,"next",a("#"+q),b[1][b[0]+1]);o(b[0]+1,b)}return false});a("#pData",s+"_2").click(function(){if(!k())return false;a("#FormError",s).hide();var b=n();if(b[0]!==-1&&b[1][b[0]-1]){a(l).triggerHandler("jqGridAddEditClickPgButtons",["prev",a("#"+q),b[1][b[0]]]);var c;if(a.isFunction(d.onclickPgButtons)){c=d.onclickPgButtons.call(l,"prev",a("#"+q),b[1][b[0]]);if(c!==void 0&&c===false)return false}if(a("#"+a.jgrid.jqID(b[1][b[0]-
1])).hasClass("ui-state-disabled"))return false;h(b[1][b[0]-1],l,q);a(l).jqGrid("setSelection",b[1][b[0]-1]);a(l).triggerHandler("jqGridAddEditAfterClickPgButtons",["prev",a("#"+q),b[1][b[0]]]);a.isFunction(d.afterclickPgButtons)&&d.afterclickPgButtons.call(l,"prev",a("#"+q),b[1][b[0]-1]);o(b[0]-1,b)}return false})}u=n();o(u[0],u)}})},viewGridRow:function(e,d){d=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,jqModal:!0,closeOnEscape:!1,
labelswidth:"30%",closeicon:[],navkeys:[!1,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0,recreateForm:!1},a.jgrid.view,d||{});c[a(this)[0].p.id]=d;return this.each(function(){function f(){(!0===c[j.p.id].closeOnEscape||!0===c[j.p.id].navkeys[0])&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(p.modalhead)).focus()},0)}function b(b,c,e,f){var g,i,h,j=0,k,l,m=[],o=!1,n,p="<td class='CaptionTD form-view-label ui-widget-content' width='"+d.labelswidth+
"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",q="",s=["integer","number","currency"],t=0,r=0,u,w,z;for(n=1;n<=f;n++)q+=1===n?p:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(c.p.colModel).each(function(){i=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1;!i&&"right"===this.align&&(this.formatter&&-1!==a.inArray(this.formatter,s)?t=Math.max(t,
parseInt(this.width,10)):r=Math.max(r,parseInt(this.width,10)))});u=0!==t?t:0!==r?r:0;o=a(c).jqGrid("getInd",b);a(c.p.colModel).each(function(b){g=this.name;w=!1;l=(i=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";z="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&z){k=!1===o?"":g===c.p.ExpandColumn&&!0===c.p.treeGrid?a("td:eq("+b+")",c.rows[o]).text():a("td:eq("+b+")",c.rows[o]).html();w="right"===this.align&&
0!==u?!0:!1;var d=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),n=parseInt(d.rowpos,10)||j+1,p=parseInt(2*(parseInt(d.colpos,10)||1),10);if(d.rowabove){var s=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+d.rowcontent+"</td></tr>");a(e).append(s);s[0].rp=n}h=a(e).find("tr[rowpos="+n+"]");0===h.length&&(h=a("<tr "+l+" rowpos='"+n+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(h).append(q),a(e).append(h),h[0].rp=n);a("td:eq("+(p-2)+")",h[0]).html("<b>"+(void 0===d.label?c.p.colNames[b]:
d.label)+"</b>");a("td:eq("+(p-1)+")",h[0]).append("<span>"+k+"</span>").attr("id","v_"+g);w&&a("td:eq("+(p-1)+") span",h[0]).css({"text-align":"right",width:u+"px"});m[j]=b;j++}});0<j&&(b=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+b+"'/></td></tr>"),b[0].rp=j+99,a(e).append(b));return m}function h(b,d){var c,e,f=0,g,i;if(i=a(d).jqGrid("getInd",b,!0))a("td",i).each(function(b){c=
d.p.colModel[b].name;e=d.p.colModel[b].editrules&&!0===d.p.colModel[b].editrules.edithidden?!1:!0===d.p.colModel[b].hidden?!0:!1;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&(g=c===d.p.ExpandColumn&&!0===d.p.treeGrid?a(this).text():a(this).html(),c=a.jgrid.jqID("v_"+c),a("#"+c+" span","#"+o).html(g),e&&a("#"+c,"#"+o).parents("tr:first").hide(),f++)}),0<f&&a("#id_g","#"+o).val(b)}function g(b,d){var c=d[1].length-1;0===b?a("#pData","#"+o+"_2").addClass("ui-state-disabled"):void 0!==d[1][b-1]&&a("#"+a.jgrid.jqID(d[1][b-
1])).hasClass("ui-state-disabled")?a("#pData",o+"_2").addClass("ui-state-disabled"):a("#pData","#"+o+"_2").removeClass("ui-state-disabled");b===c?a("#nData","#"+o+"_2").addClass("ui-state-disabled"):void 0!==d[1][b+1]&&a("#"+a.jgrid.jqID(d[1][b+1])).hasClass("ui-state-disabled")?a("#nData",o+"_2").addClass("ui-state-disabled"):a("#nData","#"+o+"_2").removeClass("ui-state-disabled")}function i(){var b=a(j).jqGrid("getDataIDs"),d=a("#id_g","#"+o).val();return[a.inArray(d,b),b]}var j=this;if(j.grid&&
e){var k=j.p.id,m="ViewGrid_"+a.jgrid.jqID(k),o="ViewTbl_"+a.jgrid.jqID(k),n="ViewGrid_"+k,l="ViewTbl_"+k,p={themodal:"viewmod"+k,modalhead:"viewhd"+k,modalcontent:"viewcnt"+k,scrollelm:m},q=a.isFunction(c[j.p.id].beforeInitData)?c[j.p.id].beforeInitData:!1,r=!0,s=1,t=0;!0===d.recreateForm&&void 0!==a("#"+a.jgrid.jqID(p.themodal))[0]&&a("#"+a.jgrid.jqID(p.themodal)).remove();if(void 0!==a("#"+a.jgrid.jqID(p.themodal))[0]){q&&(r=q.call(j,a("#"+m)),void 0===r&&(r=!0));if(!1===r)return;a(".ui-jqdialog-title",
"#"+a.jgrid.jqID(p.modalhead)).html(d.caption);a("#FormError","#"+o).hide();h(e,j);a.isFunction(c[j.p.id].beforeShowForm)&&c[j.p.id].beforeShowForm.call(j,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(p.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:d.jqModal,jqM:!1,overlay:d.overlay,modal:d.modal});f()}else{var u=isNaN(d.dataheight)?d.dataheight:d.dataheight+"px",w=isNaN(d.datawidth)?d.datawidth:d.datawidth+"px",n=a("<form name='FormPost' id='"+n+"' class='FormGrid' style='width:"+w+";overflow:auto;position:relative;height:"+
u+";'></form>"),z=a("<table id='"+l+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");q&&(r=q.call(j,a("#"+m)),void 0===r&&(r=!0));if(!1===r)return;a(j.p.colModel).each(function(){var a=this.formoptions;s=Math.max(s,a?a.colpos||0:0);t=Math.max(t,a?a.rowpos||0:0)});a(n).append(z);b(e,j,z,s);l="rtl"===j.p.direction?!0:!1;q="<a href='javascript:void(0)' id='"+(l?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
r="<a href='javascript:void(0)' id='"+(l?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";u="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+d.bClose+"</a>";if(0<t){var J=[];a.each(a(z)[0].rows,function(a,b){J[a]=b});J.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(J,function(b,d){a("tbody",z).append(d)})}d.gbox="#gbox_"+a.jgrid.jqID(k);n=a("<div></div>").append(n).append("<table border='0' class='EditTable' id='"+
o+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='"+d.labelswidth+"'>"+(l?r+q:q+r)+"</td><td class='EditButton'>"+u+"</td></tr></tbody></table>");a.jgrid.createModal(p,n,d,"#gview_"+a.jgrid.jqID(j.p.id),a("#gview_"+a.jgrid.jqID(j.p.id))[0]);l&&(a("#pData, #nData","#"+o+"_2").css("float","right"),a(".EditButton","#"+o+"_2").css("text-align","left"));d.viewPagerButtons||a("#pData, #nData","#"+o+"_2").hide();n=null;a("#"+p.themodal).keydown(function(b){if(b.which===27){c[j.p.id].closeOnEscape&&
...
d.closeicon[2]+"'></span>");a.isFunction(d.beforeShowForm)&&d.beforeShowForm.call(j,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(p.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:d.jqModal,overlay:d.overlay,modal:d.modal});a(".fm-button:not(.ui-state-disabled)","#"+o+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});f();a("#cData","#"+o+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(p.themodal),{gb:"#gbox_"+a.jgrid.jqID(k),jqm:d.jqModal,
onClose:d.onClose});return false});a("#nData","#"+o+"_2").click(function(){a("#FormError","#"+o).hide();var b=i();b[0]=parseInt(b[0],10);if(b[0]!==-1&&b[1][b[0]+1]){a.isFunction(d.onclickPgButtons)&&d.onclickPgButtons.call(j,"next",a("#"+m),b[1][b[0]]);h(b[1][b[0]+1],j);a(j).jqGrid("setSelection",b[1][b[0]+1]);a.isFunction(d.afterclickPgButtons)&&d.afterclickPgButtons.call(j,"next",a("#"+m),b[1][b[0]+1]);g(b[0]+1,b)}f();return false});a("#pData","#"+o+"_2").click(function(){a("#FormError","#"+o).hide();
var b=i();if(b[0]!==-1&&b[1][b[0]-1]){a.isFunction(d.onclickPgButtons)&&d.onclickPgButtons.call(j,"prev",a("#"+m),b[1][b[0]]);h(b[1][b[0]-1],j);a(j).jqGrid("setSelection",b[1][b[0]-1]);a.isFunction(d.afterclickPgButtons)&&d.afterclickPgButtons.call(j,"prev",a("#"+m),b[1][b[0]-1]);g(b[0]-1,b)}f();return false})}n=i();g(n[0],n)}})},delGridRow:function(e,d){d=a.extend(!0,{top:0,left:0,width:240,height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,url:"",mtype:"POST",reloadAfterSubmit:!0,
...
!1,i=f.p.id,j={},k=!0,m="DelTbl_"+a.jgrid.jqID(i),o,n,l,p,q="DelTbl_"+i,r={themodal:"delmod"+i,modalhead:"delhd"+i,modalcontent:"delcnt"+i,scrollelm:m};a.isArray(e)&&(e=e.join());if(void 0!==a("#"+a.jgrid.jqID(r.themodal))[0]){g&&(k=g.call(f,a("#"+m)),void 0===k&&(k=!0));if(!1===k)return;a("#DelData>td","#"+m).text(e);a("#DelError","#"+m).hide();!0===c[f.p.id].processing&&(c[f.p.id].processing=!1,a("#dData","#"+m).removeClass("ui-state-active"));b&&c[f.p.id].beforeShowForm.call(f,a("#"+m));a.jgrid.viewModal("#"+
...
c[f.p.id],g)||{});a.isFunction(c[f.p.id].beforeSubmit)&&(b=c[f.p.id].beforeSubmit.call(f,g));if(b[0]&&!c[f.p.id].processing){c[f.p.id].processing=true;l=f.p.prmNames;o=a.extend({},c[f.p.id].delData,j);p=l.oper;o[p]=l.deloper;n=l.id;g=(""+g).split(",");if(!g.length)return false;for(e in g)g.hasOwnProperty(e)&&(g[e]=a.jgrid.stripPref(f.p.idPrefix,g[e]));o[n]=g.join();a(this).addClass("ui-state-active");e=a.extend({url:c[f.p.id].url||a(f).jqGrid("getGridParam","editurl"),type:c[f.p.id].mtype,data:a.isFunction(c[f.p.id].serializeDelData)?
c[f.p.id].serializeDelData.call(f,o):o,complete:function(e,h){var j;if(e.status>=300&&e.status!==304){b[0]=false;b[1]=a.isFunction(c[f.p.id].errorTextFormat)?c[f.p.id].errorTextFormat.call(f,e):h+" Status: '"+e.statusText+"'. Error code: "+e.status}else a.isFunction(c[f.p.id].afterSubmit)&&(b=c[f.p.id].afterSubmit.call(f,e,o));if(b[0]===false){a("#DelError>td","#"+m).html(b[1]);a("#DelError","#"+m).show()}else{if(c[f.p.id].reloadAfterSubmit&&f.p.datatype!=="local")a(f).trigger("reloadGrid");else{if(f.p.treeGrid===
...
a.jgrid.jqID(k.p.id),a("#gbox_"+a.jgrid.jqID(k.p.id))[0],!0));var o=1,n,l=function(){a(this).hasClass("ui-state-disabled")||a(this).addClass("ui-state-hover")},p=function(){a(this).removeClass("ui-state-hover")};d.cloneToTop&&k.p.toppager&&(o=2);for(n=0;n<o;n++){var q=a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),r,s;0===n?(r=c,s=k.p.id,r===k.p.toppager&&(s+="_top",o=1)):(r=k.p.toppager,s=
k.p.id+"_top");"rtl"===k.p.direction&&a(q).attr("dir","rtl").css("float","right");d.add&&(b=b||{},m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+d.addicon+"'></span>"+d.addtext+"</div>"),a("tr",q).append(m),a(m,q).attr({title:d.addtitle||"",id:b.id||"add_"+s}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(d.addfunc)?d.addfunc.call(k):a(k).jqGrid("editGridRow","new",b));return false}).hover(l,p),m=null);d.edit&&
...
a("#jqg_alrt").focus()}}return false}).hover(l,p),m=null);d.del&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),h=h||{},a(m).append("<div class='ui-pg-div'><span class='ui-icon "+d.delicon+"'></span>"+d.deltext+"</div>"),a("tr",q).append(m),a(m,q).attr({title:d.deltitle||"",id:h.id||"del_"+s}).click(function(){if(!a(this).hasClass("ui-state-disabled")){var b;if(k.p.multiselect){b=k.p.selarrrow;b.length===0&&(b=null)}else b=k.p.selrow;if(b)a.isFunction(d.delfunc)?d.delfunc.call(k,b):a(k).jqGrid("delGridRow",
...
q).attr({title:d.searchtitle||"",id:g.id||"search_"+s}).click(function(){a(this).hasClass("ui-state-disabled")||(a.isFunction(d.searchfunc)?d.searchfunc.call(k,g):a(k).jqGrid("searchGrid",g));return false}).hover(l,p),g.showOnLoad&&!0===g.showOnLoad&&a(m,q).click(),m=null);d.refresh&&(m=a("<td class='ui-pg-button ui-corner-all'></td>"),a(m).append("<div class='ui-pg-div'><span class='ui-icon "+d.refreshicon+"'></span>"+d.refreshtext+"</div>"),a("tr",q).append(m),a(m,q).attr({title:d.refreshtitle||
"",id:"refresh_"+s}).click(function(){if(!a(this).hasClass("ui-state-disabled")){a.isFunction(d.beforeRefresh)&&d.beforeRefresh.call(k);k.p.search=false;try{var b=k.p.id;k.p.postData.filters="";try{a("#fbox_"+a.jgrid.jqID(b)).jqFilter("resetFilter")}catch(c){}a.isFunction(k.clearToolbar)&&k.clearToolbar.call(k,false)}catch(e){}switch(d.refreshstate){case "firstpage":a(k).trigger("reloadGrid",[{page:1}]);break;case "current":a(k).trigger("reloadGrid",[{current:true}])}a.isFunction(d.afterRefresh)&&
...
e.length&&160===e.charCodeAt(0))e="";var u=a.jgrid.createEl.call(b,j[h].edittype,s,e,!0,a.extend({},a.jgrid.ajaxOptions,b.p.ajaxSelectOptions||{}));a(u).addClass("editable");k?a("span:first",this).append(u):a(this).append(u);a.jgrid.bindEv.call(b,u,s);"select"===j[h].edittype&&void 0!==j[h].editoptions&&!0===j[h].editoptions.multiple&&void 0===j[h].editoptions.dataUrl&&a.jgrid.msie&&a(u).width(a(u).width());f++}}),0<f&&(i.id=c,b.p.savedRow.push(i),a(h).attr("editable","1"),a("td:eq("+g+") input",
...
a.makeArray(arguments).slice(1),j={};if("object"===a.type(i[0]))j=i[0];else if(a.isFunction(e)&&(j.successfunc=e),void 0!==d&&(j.url=d),void 0!==f&&(j.extraparam=f),a.isFunction(b)&&(j.aftersavefunc=b),a.isFunction(h)&&(j.errorfunc=h),a.isFunction(g))j.afterrestorefunc=g;var j=a.extend(!0,{successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,mtype:"POST"},a.jgrid.inlineEdit,j),k=!1,m=this[0],o,n={},l={},p={},q,r,s;if(!m.grid)return k;
s=a(m).jqGrid("getInd",c,!0);if(!1===s)return k;i=a.isFunction(j.beforeSaveRow)?j.beforeSaveRow.call(m,j,c):void 0;void 0===i&&(i=!0);if(i){i=a(s).attr("editable");j.url=j.url||m.p.editurl;if("1"===i){var t;a('td[role="gridcell"]',s).each(function(b){t=m.p.colModel[b];o=t.name;if("cb"!==o&&"subgrid"!==o&&!0===t.editable&&"rn"!==o&&!a(this).hasClass("not-editable-cell")){switch(t.edittype){case "checkbox":var d=["Yes","No"];t.editoptions&&(d=t.editoptions.value.split(":"));n[o]=a("input",this).is(":checked")?
d[0]:d[1];break;case "text":case "password":case "textarea":case "button":n[o]=a("input, textarea",this).val();break;case "select":if(t.editoptions.multiple){var d=a("select",this),c=[];n[o]=a(d).val();n[o]=n[o]?n[o].join(","):"";a("select option:selected",this).each(function(b,d){c[b]=a(d).text()});l[o]=c.join(",")}else n[o]=a("select option:selected",this).val(),l[o]=a("select option:selected",this).text();t.formatter&&"select"===t.formatter&&(l={});break;case "custom":try{if(t.editoptions&&a.isFunction(t.editoptions.custom_value)){if(n[o]=
t.editoptions.custom_value.call(m,a(".customelement",this),"get"),void 0===n[o])throw"e2";}else throw"e1";}catch(e){"e1"===e&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===e?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}r=a.jgrid.checkValues.call(m,n[o],b);if(!1===r[0])return r[1]=
n[o]+" "+r[1],!1;m.p.autoencode&&(n[o]=a.jgrid.htmlEncode(n[o]));"clientArray"!==j.url&&t.editoptions&&!0===t.editoptions.NullIfEmpty&&""===n[o]&&(p[o]="null")}});if(!1===r[0]){try{var u=m.rows.namedItem(c),w=a.jgrid.findPos(u);a.jgrid.info_dialog(a.jgrid.errors.errcap,r[1],a.jgrid.edit.bClose,{left:w[0],top:w[1]+a(u).outerHeight()})}catch(z){alert(r[1])}return k}i=m.p.prmNames;u=c;w=!1===m.p.keyIndex?i.id:m.p.colModel[m.p.keyIndex+(!0===m.p.rownumbers?1:0)+(!0===m.p.multiselect?1:0)+(!0===m.p.subGrid?
1:0)].name;if(n){n[i.oper]=i.editoper;if(void 0===n[w]||""===n[w])n[w]=c;else if(s.id!==m.p.idPrefix+n[w]&&(i=a.jgrid.stripPref(m.p.idPrefix,c),void 0!==m.p._index[i]&&(m.p._index[n[w]]=m.p._index[i],delete m.p._index[i]),c=m.p.idPrefix+n[w],a(s).attr("id",c),m.p.selrow===u&&(m.p.selrow=c),a.isArray(m.p.selarrrow)&&(i=a.inArray(u,m.p.selarrrow),0<=i&&(m.p.selarrrow[i]=c)),m.p.multiselect))i="jqg_"+m.p.id+"_"+c,a("input.cbox",s).attr("id",i).attr("name",i);void 0===m.p.inlineData&&(m.p.inlineData=
{});n=a.extend({},n,m.p.inlineData,j.extraparam)}if("clientArray"===j.url){n=a.extend({},n,l);m.p.autoencode&&a.each(n,function(b,d){n[b]=a.jgrid.htmlDecode(d)});i=a(m).jqGrid("setRowData",c,n);a(s).attr("editable","0");for(w=0;w<m.p.savedRow.length;w++)if(""+m.p.savedRow[w].id===""+u){q=w;break}0<=q&&m.p.savedRow.splice(q,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[c,i,n,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,c,i,j);k=!0;a(s).removeClass("jqgrid-new-row").unbind("keydown")}else a("#lui_"+
a.jgrid.jqID(m.p.id)).show(),p=a.extend({},n,p),p[w]=a.jgrid.stripPref(m.p.idPrefix,p[w]),a.ajax(a.extend({url:j.url,data:a.isFunction(m.p.serializeRowData)?m.p.serializeRowData.call(m,p):p,type:j.mtype,async:!1,complete:function(b,d){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();if("success"===d){var e=!0,f;f=a(m).triggerHandler("jqGridInlineSuccessSaveRow",[b,c,j]);a.isArray(f)||(f=[!0,n]);f[0]&&a.isFunction(j.successfunc)&&(f=j.successfunc.call(m,b));a.isArray(f)?(e=f[0],n=f[1]||n):e=f;if(!0===e){m.p.autoencode&&
a.each(n,function(b,d){n[b]=a.jgrid.htmlDecode(d)});n=a.extend({},n,l);a(m).jqGrid("setRowData",c,n);a(s).attr("editable","0");for(e=0;e<m.p.savedRow.length;e++)if(""+m.p.savedRow[e].id===""+c){q=e;break}0<=q&&m.p.savedRow.splice(q,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[c,b,n,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,c,b);k=!0;a(s).removeClass("jqgrid-new-row").unbind("keydown")}else a(m).triggerHandler("jqGridInlineErrorSaveRow",[c,b,d,null,j]),a.isFunction(j.errorfunc)&&
...
k=a.jgrid.jqID(j);switch(i.edittype){case "select":if(i.editoptions.multiple){var k=a("#"+c+"_"+k,d.rows[c]),m=[];(h=a(k).val())?h.join(","):h="";a("option:selected",k).each(function(b,d){m[b]=a(d).text()});g=m.join(",")}else h=a("#"+c+"_"+k+" option:selected",d.rows[c]).val(),g=a("#"+c+"_"+k+" option:selected",d.rows[c]).text();i.formatter&&(g=h);break;case "checkbox":var o=["Yes","No"];i.editoptions&&(o=i.editoptions.value.split(":"));g=h=a("#"+c+"_"+k,d.rows[c]).is(":checked")?o[0]:o[1];break;
case "password":case "text":case "textarea":case "button":g=h=a("#"+c+"_"+k,d.rows[c]).val();break;case "custom":try{if(i.editoptions&&a.isFunction(i.editoptions.custom_value)){h=i.editoptions.custom_value.call(d,a(".customelement",b),"get");if(void 0===h)throw"e2";g=h}else throw"e1";}catch(n){"e1"===n&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===n?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,n.message,a.jgrid.edit.bClose)}}if(g!==d.p.savedRow[f].v){if(f=a(d).triggerHandler("jqGridBeforeSaveCell",[d.rows[c].id,j,h,c,e]))g=h=f;if(a.isFunction(d.p.beforeSaveCell)&&(f=d.p.beforeSaveCell.call(d,d.rows[c].id,j,h,c,e)))g=h=f;var l=a.jgrid.checkValues.call(d,h,e);if(!0===l[0]){f=a(d).triggerHandler("jqGridBeforeSubmitCell",[d.rows[c].id,j,h,c,e])||{};a.isFunction(d.p.beforeSubmitCell)&&((f=d.p.beforeSubmitCell.call(d,d.rows[c].id,
j,h,c,e))||(f={}));0<a("input.hasDatepicker",b).length&&a("input.hasDatepicker",b).datepicker("hide");if("remote"===d.p.cellsubmit)if(d.p.cellurl){var p={};d.p.autoencode&&(h=a.jgrid.htmlEncode(h));p[j]=h;o=d.p.prmNames;i=o.id;k=o.oper;p[i]=a.jgrid.stripPref(d.p.idPrefix,d.rows[c].id);p[k]=o.editoper;p=a.extend(f,p);a("#lui_"+a.jgrid.jqID(d.p.id)).show();d.grid.hDiv.loading=!0;a.ajax(a.extend({url:d.p.cellurl,data:a.isFunction(d.p.serializeCellData)?d.p.serializeCellData.call(d,p):p,type:"POST",complete:function(f,
...
url:d.p.subGridUrl,dataType:d.p.subgridtype,data:a.isFunction(d.p.serializeSubGridData)?d.p.serializeSubGridData.call(d,f):f,complete:function(c){d.p.subgridtype==="xml"?b(c.responseXML,e):h(a.jgrid.parse(c.responseText),e)}},a.jgrid.ajaxOptions,d.p.ajaxSubgridOptions||{}))}return!1},i,j,k,m=0,o,n;a.each(d.p.colModel,function(){(!0===this.hidden||"rn"===this.name||"cb"===this.name)&&m++});var l=d.rows.length,p=1;void 0!==e&&0<e&&(p=e,l=e+1);for(;p<l;)a(d.rows[p]).hasClass("jqgrow")&&a(d.rows[p].cells[c]).bind("click",
function(){var b=a(this).parent("tr")[0];n=b.nextSibling;if(a(this).hasClass("sgcollapsed")){j=d.p.id;i=b.id;if(d.p.subGridOptions.reloadOnExpand===true||d.p.subGridOptions.reloadOnExpand===false&&!a(n).hasClass("ui-subgrid")){k=c>=1?"<td colspan='"+c+"'>&#160;</td>":"";o=a(d).triggerHandler("jqGridSubGridBeforeExpand",[j+"_"+i,i]);(o=o===false||o==="stop"?false:true)&&a.isFunction(d.p.subGridBeforeExpand)&&(o=d.p.subGridBeforeExpand.call(d,j+"_"+i,i));if(o===false)return false;a(b).after("<tr role='row' class='ui-subgrid'>"+
k+"<td class='ui-widget-content subgrid-cell'><span class='ui-icon "+d.p.subGridOptions.openicon+"'></span></td><td colspan='"+parseInt(d.p.colNames.length-1-m,10)+"' class='ui-widget-content subgrid-data'><div id="+j+"_"+i+" class='tablediv'></div></td></tr>");a(d).triggerHandler("jqGridSubGridRowExpanded",[j+"_"+i,i]);a.isFunction(d.p.subGridRowExpanded)?d.p.subGridRowExpanded.call(d,j+"_"+i,i):g(b)}else a(n).show();a(this).html("<a href='javascript:void(0);'><span class='ui-icon "+d.p.subGridOptions.minusicon+
"'></span></a>").removeClass("sgcollapsed").addClass("sgexpanded");d.p.subGridOptions.selectOnExpand&&a(d).jqGrid("setSelection",i)}else if(a(this).hasClass("sgexpanded")){o=a(d).triggerHandler("jqGridSubGridRowColapsed",[j+"_"+i,i]);if((o=o===false||o==="stop"?false:true)&&a.isFunction(d.p.subGridRowColapsed)){i=b.id;o=d.p.subGridRowColapsed.call(d,j+"_"+i,i)}if(o===false)return false;d.p.subGridOptions.reloadOnExpand===true?a(n).remove(".ui-subgrid"):a(n).hasClass("ui-subgrid")&&a(n).hide();a(this).html("<a href='javascript:void(0);'><span class='ui-icon "+
...
(function(a){a.jgrid.extend({setTreeNode:function(c,e){return this.each(function(){var d=this;if(d.grid&&d.p.treeGrid)for(var f=d.p.expColInd,b=d.p.treeReader.expanded_field,h=d.p.treeReader.leaf_field,g=d.p.treeReader.level_field,i=d.p.treeReader.icon_field,j=d.p.treeReader.loaded,k,m,o,n;c<e;)n=a.jgrid.stripPref(d.p.idPrefix,d.rows[c].id),n=d.p.data[d.p._index[n]],"nested"===d.p.treeGridModel&&!n[h]&&(k=parseInt(n[d.p.treeReader.left_field],10),m=parseInt(n[d.p.treeReader.right_field],10),n[h]=
m===k+1?"true":"false",d.rows[c].cells[d.p._treeleafpos].innerHTML=n[h]),k=parseInt(n[g],10),0===d.p.tree_root_level?(o=k+1,m=k):(o=k,m=k-1),o="<div class='tree-wrap tree-wrap-"+d.p.direction+"' style='width:"+18*o+"px;'>",o+="<div style='"+("rtl"===d.p.direction?"right:":"left:")+18*m+"px;' class='ui-icon ",void 0!==n[j]&&(n[j]="true"===n[j]||!0===n[j]?!0:!1),"true"===n[h]||!0===n[h]?(o+=(void 0!==n[i]&&""!==n[i]?n[i]:d.p.treeIcons.leaf)+" tree-leaf treeclick",n[h]=!0,m="leaf"):(n[h]=!1,m=""),n[b]=
("true"===n[b]||!0===n[b]?!0:!1)&&(n[j]||void 0===n[j]),o=!1===n[b]?o+(!0===n[h]?"'":d.p.treeIcons.plus+" tree-plus treeclick'"):o+(!0===n[h]?"'":d.p.treeIcons.minus+" tree-minus treeclick'"),o+="></div></div>",a(d.rows[c].cells[f]).wrapInner("<span class='cell-wrapper"+m+"'></span>").prepend(o),k!==parseInt(d.p.tree_root_level,10)&&((n=(n=a(d).jqGrid("getNodeParent",n))&&n.hasOwnProperty(b)?n[b]:!0)||a(d.rows[c]).css("display","none")),a(d.rows[c].cells[f]).find("div.treeclick").bind("click",function(c){c=
...
10)>=i&&parseInt(this[b],10)<=j&&e.push(this)});break;case "adjacency":if(c){e.push(c);var m=d.p.treeReader.parent_id_field,o=d.p.localReader.id;a(this.p.data).each(function(b){f=e.length;for(b=0;b<f;b++)if(a.jgrid.stripPref(d.p.idPrefix,e[b][o])===this[m]){e.push(this);break}})}}});return e},getNodeAncestors:function(c){var e=[];this.each(function(){if(this.grid&&this.p.treeGrid)for(var d=a(this).jqGrid("getNodeParent",c);d;)e.push(d),d=a(this).jqGrid("getNodeParent",d)});return e},isVisibleNode:function(c){var e=
...
h,{stype:"integer"}).select();if(e.length)for(i in e)e.hasOwnProperty(i)&&(e[i][b]=parseInt(e[i][b],10)-g)}}})},addChildNode:function(c,e,d,f){var b=this[0];if(d){var h=b.p.treeReader.expanded_field,g=b.p.treeReader.leaf_field,i=b.p.treeReader.level_field,j=b.p.treeReader.parent_id_field,k=b.p.treeReader.left_field,m=b.p.treeReader.right_field,o=b.p.treeReader.loaded,n,l,p,q,r;n=0;var s=e,t;void 0===f&&(f=!1);if(void 0===c||null===c){r=b.p.data.length-1;if(0<=r)for(;0<=r;)n=Math.max(n,parseInt(b.p.data[r][b.p.localReader.id],
10)),r--;c=n+1}var u=a(b).jqGrid("getInd",e);t=!1;if(void 0===e||null===e||""===e)s=e=null,n="last",q=b.p.tree_root_level,r=b.p.data.length+1;else if(n="after",l=b.p._index[e],p=b.p.data[l],e=p[b.p.localReader.id],q=parseInt(p[i],10)+1,r=a(b).jqGrid("getFullTreeNode",p),r.length?(s=r=r[r.length-1][b.p.localReader.id],r=a(b).jqGrid("getInd",s)+1):r=a(b).jqGrid("getInd",e)+1,p[g])t=!0,p[h]=!0,a(b.rows[u]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(b.p.treeIcons.leaf+
" tree-leaf").addClass(b.p.treeIcons.minus+" tree-minus"),b.p.data[l][g]=!1,p[o]=!0;l=r+1;void 0===d[h]&&(d[h]=!1);void 0===d[o]&&(d[o]=!1);d[i]=q;void 0===d[g]&&(d[g]=!0);"adjacency"===b.p.treeGridModel&&(d[j]=e);if("nested"===b.p.treeGridModel){var w;if(null!==e){g=parseInt(p[m],10);i=a.jgrid.from(b.p.data);i=i.greaterOrEquals(m,g,{stype:"integer"});i=i.select();if(i.length)for(w in i)i.hasOwnProperty(w)&&(i[w][k]=i[w][k]>g?parseInt(i[w][k],10)+2:i[w][k],i[w][m]=i[w][m]>=g?parseInt(i[w][m],10)+
2:i[w][m]);d[k]=g;d[m]=g+1}else{g=parseInt(a(b).jqGrid("getCol",m,!1,"max"),10);i=a.jgrid.from(b.p.data).greater(k,g,{stype:"integer"}).select();if(i.length)for(w in i)i.hasOwnProperty(w)&&(i[w][k]=parseInt(i[w][k],10)+2);i=a.jgrid.from(b.p.data).greater(m,g,{stype:"integer"}).select();if(i.length)for(w in i)i.hasOwnProperty(w)&&(i[w][m]=parseInt(i[w][m],10)+2);d[k]=g+1;d[m]=g+2}}if(null===e||a(b).jqGrid("isNodeLoaded",p)||t)a(b).jqGrid("addRowData",c,d,n,s),a(b).jqGrid("setTreeNode",r,l);p&&!p[h]&&
f&&a(b.rows[u]).find("div.treeclick").click()}}})})(jQuery);
...
[c,j]);a.isFunction(this.p.onClickGroup)&&this.p.onClickGroup.call(this,c,j)});return!1},groupingRender:function(c,e){return this.each(function(){function d(a,b,d){var c=!1;if(0===b)c=d[a];else{var e=d[a].idx;if(0===e)c=d[a];else for(;0<=a;a--)if(d[a].idx===e-b){c=d[a];break}}return c}var f=this,b=f.p.groupingView,h="",g="",i,j,k=b.groupCollapse?b.plusicon:b.minusicon,m,o=[],n=b.groupField.length,k=k+(" tree-wrap-"+f.p.direction);a.each(f.p.colModel,function(a,d){var c;for(c=0;c<n;c++)if(b.groupField[c]===
d.name){o[c]=a;break}});var l=0,p=a.makeArray(b.groupSummary);p.reverse();a.each(b.groups,function(q,r){l++;j=f.p.id+"ghead_"+r.idx;i=j+"_"+q;g="<span style='cursor:pointer;' class='ui-icon "+k+"' onclick=\"jQuery('#"+a.jgrid.jqID(f.p.id)+"').jqGrid('groupingToggle','"+i+"');return false;\"></span>";try{a.isArray(b.formatDisplayField)&&a.isFunction(b.formatDisplayField[r.idx])&&(r.displayValue=b.formatDisplayField[r.idx].call(f,r.displayValue,r.value,f.p.colModel[o[r.idx]],r.idx,b)),m=f.formatter(i,
r.displayValue,o[r.idx],r.value)}catch(s){m=r.displayValue}h+='<tr id="'+i+'" role="row" class= "ui-widget-content jqgroup ui-row-'+f.p.direction+" "+j+'"><td style="padding-left:'+12*r.idx+'px;" colspan="'+e+'">'+g+a.jgrid.template(b.groupText[r.idx],m,r.cnt,r.summary)+"</td></tr>";if(n-1===r.idx){var t=b.groups[q+1],u,w,z=void 0!==t?b.groups[q+1].startRow:c.length;for(w=r.startRow;w<z;w++)h+=c[w].join("");var J;if(void 0!==t){for(J=0;J<b.groupField.length&&t.dataIndex!==b.groupField[J];J++);l=b.groupField.length-
J}for(t=0;t<l;t++)if(p[t]){w="";b.groupCollapse&&!b.showSummaryOnHide&&(w=' style="display:none;"');h+="<tr"+w+' jqfootlevel="'+(r.idx-t)+'" role="row" class="ui-widget-content jqfoot ui-row-'+f.p.direction+'">';w=d(q,t,b.groups);var x=f.p.colModel,B,F=w.cnt;for(u=0;u<e;u++){var v="<td "+f.formatCol(u,1,"")+">&#160;</td>",L="{0}";a.each(w.summary,function(){if(this.nm===x[u].name){x[u].summaryTpl&&(L=x[u].summaryTpl);"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&this.v&&0<F&&(this.v/=
F);try{B=f.formatter("",this.v,u,this)}catch(b){B=this.v}v="<td "+f.formatCol(u,1,"")+">"+a.jgrid.format(L,B)+"</td>";return!1}});h+=v}h+="</tr>"}l=J}});a("#"+a.jgrid.jqID(f.p.id)+" tbody:first").append(h);h=null})},groupingGroupBy:function(c,e){return this.each(function(){"string"===typeof c&&(c=[c]);var d=this.p.groupingView;this.p.grouping=!0;void 0===d.visibiltyOnNextGrouping&&(d.visibiltyOnNextGrouping=[]);var f;for(f=0;f<d.groupField.length;f++)!d.groupColumnShow[f]&&d.visibiltyOnNextGrouping[f]&&
...
e);if(!b.dropbyname){var h=0,o={},n,l,p=a("#"+a.jgrid.jqID(this.id)).jqGrid("getGridParam","colModel");try{for(l in e)if(e.hasOwnProperty(l)){n=p[h].name;n==="cb"||n==="rn"||n==="subgrid"||e.hasOwnProperty(l)&&p[h]&&(o[n]=e[l]);h++}e=o}catch(q){}}c.helper.dropped=true;if(b.beforedrop&&a.isFunction(b.beforedrop)){n=b.beforedrop.call(this,d,c,e,a("#"+a.jgrid.jqID(f.p.id)),a(this));n!==void 0&&n!==null&&typeof n==="object"&&(e=n)}if(c.helper.dropped){var r;if(b.autoid)if(a.isFunction(b.autoid))r=b.autoid.call(this,
