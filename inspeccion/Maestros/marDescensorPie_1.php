...
// Write the SQL Query
$grid->SelectCommand = 'SELECT * FROM LiteralPie WHERE Tipo=5 AND Grupo='.$_SESSION['Grupo'];
...
$grid->setUrl('marDescensorPie_1.php');     // Set the url from where we obtain the data
