...
*	ODG, 22.01.13 Se modifica Text, Cell con Parámetro para tamaño de cadena   *
*******************************************************************************/
...
// ODG, 22.01.13 Parámetros Máximo Cadena
function Text($x, $y, $txt, $Max=0)
{   
	if ($Max > 0)
...
// ODG, 22.01.13 Parámetros Máximo Cadena
function Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='', $Max=0)
{   
	if ($Max > 0)
		$txt = substr($txt, 0, $Max);
