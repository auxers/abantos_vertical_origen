...
// Write the SQL Query
$grid->SelectCommand = 'SELECT * FROM ModeloExt';
$grid->table='ModeloExt';		  	   // set the table where add-del-edit data
...
$grid->setUrl('modExtintor_1.php');   // Set the url from where we obtain the data
